...
public class GeneratedFunctions {
	public interface MeosLibraryPartA {
		...
		int meos_set_datestyle(String newval, Pointer extra);

		int meos_set_intervalstyle(String newval, int extra);
		...
		int add_timestamptz_interval(int t, Pointer interv);

		int bool_in(String str);

		String bool_out(int b);

		Pointer cstring2text(String str);

		int date_to_timestamp(int dateVal);

		int date_to_timestamptz(int d);
		...
		int minus_timestamptz_interval(int t, Pointer interv);

		Pointer minus_timestamptz_timestamptz(int t1, int t2);
		...
		String pg_timestamp_out(int t);

		int pg_timestamptz_in(String str, int typmod);

		String pg_timestamptz_out(int t);
		...
		int timestamptz_shift(int t, Pointer interv);

		int timestamp_to_date(int t);

		int timestamptz_to_date(int t);

		Pointer bigintset_in(String str);

		String bigintset_out(Pointer set);

		Pointer bigintspan_expand(Pointer s, int value);
		...
		Pointer bigintspan_make(int lower, int upper, int lower_inc, int upper_inc);

		Pointer dateset_make(Pointer values, int count);

		Pointer datespan_make(int lower, int upper, int lower_inc, int upper_inc);

		Pointer floatset_make(Pointer values, int count);

		Pointer floatspan_make(double lower, double upper, int lower_inc, int upper_inc);

		Pointer intset_make(Pointer values, int count);

		Pointer intspan_make(int lower, int upper, int lower_inc, int upper_inc);
		...
		Pointer tstzspan_make(int lower, int upper, int lower_inc, int upper_inc);

		Pointer bigint_to_set(int i);
		...
		Pointer timestamptz_to_set(int t);

		Pointer timestamptz_to_span(int t);

		Pointer timestamptz_to_spanset(int t);
		...
		int bigintset_end_value(Pointer s);

		int bigintset_start_value(Pointer s);

		int bigintset_value_n(Pointer s, int n, Pointer result);
		...
		int datespanset_date_n(Pointer ss, int n, Pointer result);

		Pointer datespanset_dates(Pointer ss);

		Pointer datespanset_duration(Pointer ss, int boundspan);
		...
		int floatset_value_n(Pointer s, int n, Pointer result);
		...
		double floatspanset_width(Pointer ss, int boundspan);

		int intset_end_value(Pointer s);

		int intset_start_value(Pointer s);

		int intset_value_n(Pointer s, int n, Pointer result);
		...
		int intspanset_width(Pointer ss, int boundspan);
		...
		int span_hash_extended(Pointer s, int seed);

		int span_lower_inc(Pointer s);

		int span_upper_inc(Pointer s);
		...
		int spanset_lower_inc(Pointer ss);
		...
		int spanset_upper_inc(Pointer ss);

		Pointer textset_end_value(Pointer s);

		Pointer textset_start_value(Pointer s);

		int textset_value_n(Pointer s, int n, Pointer result);

		Pointer textset_values(Pointer s);

		int tstzset_end_value(Pointer s);

		int tstzset_start_value(Pointer s);

		int tstzset_value_n(Pointer s, int n, Pointer result);

		Pointer tstzset_values(Pointer s);

		Pointer tstzspan_duration(Pointer s);

		int tstzspan_lower(Pointer s);

		int tstzspan_upper(Pointer s);

		Pointer tstzspanset_duration(Pointer ss, int boundspan);

		int tstzspanset_end_timestamptz(Pointer ss);

		int tstzspanset_lower(Pointer ss);

		int tstzspanset_num_timestamps(Pointer ss);

		int tstzspanset_start_timestamptz(Pointer ss);

		Pointer tstzspanset_timestamps(Pointer ss);

		int tstzspanset_timestamptz_n(Pointer ss, int n, Pointer result);

		int tstzspanset_upper(Pointer ss);

		Pointer bigintset_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth);

		Pointer bigintspan_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth);

		Pointer bigintspanset_shift_scale(Pointer ss, int shift, int width, int hasshift, int haswidth);

		Pointer dateset_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth);

		Pointer datespan_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth);

		Pointer datespanset_shift_scale(Pointer ss, int shift, int width, int hasshift, int haswidth);

		Pointer floatset_ceil(Pointer s);

		Pointer floatset_degrees(Pointer s, int normalize);

		Pointer floatset_floor(Pointer s);

		Pointer floatset_radians(Pointer s);

		Pointer floatset_shift_scale(Pointer s, double shift, double width, int hasshift, int haswidth);

		Pointer floatspan_ceil(Pointer s);

		Pointer floatspan_degrees(Pointer s, int normalize);
		...
		Pointer floatspan_shift_scale(Pointer s, double shift, double width, int hasshift, int haswidth);

		Pointer floatspanset_ceil(Pointer ss);

		Pointer floatspanset_floor(Pointer ss);

		Pointer floatspanset_degrees(Pointer ss, int normalize);

		Pointer floatspanset_radians(Pointer ss);

		Pointer floatspanset_round(Pointer ss, int maxdd);

		Pointer floatspanset_shift_scale(Pointer ss, double shift, double width, int hasshift, int haswidth);

		Pointer intset_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth);

		Pointer intspan_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth);

		Pointer intspanset_shift_scale(Pointer ss, int shift, int width, int hasshift, int haswidth);
		...
		int timestamptz_tprecision(int t, Pointer duration, int torigin);

		Pointer tstzset_shift_scale(Pointer s, Pointer shift, Pointer duration);

		Pointer tstzset_tprecision(Pointer s, Pointer duration, int torigin);

		Pointer tstzspan_shift_scale(Pointer s, Pointer shift, Pointer duration);

		Pointer tstzspan_tprecision(Pointer s, Pointer duration, int torigin);

		Pointer tstzspanset_shift_scale(Pointer ss, Pointer shift, Pointer duration);

		Pointer tstzspanset_tprecision(Pointer ss, Pointer duration, int torigin);

		int set_cmp(Pointer s1, Pointer s2);

		int set_eq(Pointer s1, Pointer s2);

		int set_ge(Pointer s1, Pointer s2);

		int set_gt(Pointer s1, Pointer s2);

		int set_le(Pointer s1, Pointer s2);

		int set_lt(Pointer s1, Pointer s2);

		int set_ne(Pointer s1, Pointer s2);

		int span_cmp(Pointer s1, Pointer s2);

		int span_eq(Pointer s1, Pointer s2);

		int span_ge(Pointer s1, Pointer s2);

		int span_gt(Pointer s1, Pointer s2);

		int span_le(Pointer s1, Pointer s2);

		int span_lt(Pointer s1, Pointer s2);

		int span_ne(Pointer s1, Pointer s2);

		int spanset_cmp(Pointer ss1, Pointer ss2);

		int spanset_eq(Pointer ss1, Pointer ss2);

		int spanset_ge(Pointer ss1, Pointer ss2);

		int spanset_gt(Pointer ss1, Pointer ss2);

		int spanset_le(Pointer ss1, Pointer ss2);

		int spanset_lt(Pointer ss1, Pointer ss2);

		int spanset_ne(Pointer ss1, Pointer ss2);
		...
		int adjacent_span_bigint(Pointer s, int i);

		int adjacent_span_date(Pointer s, int d);

		int adjacent_span_float(Pointer s, double d);

		int adjacent_span_int(Pointer s, int i);

		int adjacent_span_span(Pointer s1, Pointer s2);

		int adjacent_span_spanset(Pointer s, Pointer ss);

		int adjacent_span_timestamptz(Pointer s, int t);

		int adjacent_spanset_bigint(Pointer ss, int i);

		int adjacent_spanset_date(Pointer ss, int d);

		int adjacent_spanset_float(Pointer ss, double d);

		int adjacent_spanset_int(Pointer ss, int i);

		int adjacent_spanset_timestamptz(Pointer ss, int t);

		int adjacent_spanset_span(Pointer ss, Pointer s);

		int adjacent_spanset_spanset(Pointer ss1, Pointer ss2);

		int contained_bigint_set(int i, Pointer s);

		int contained_bigint_span(int i, Pointer s);

		int contained_bigint_spanset(int i, Pointer ss);

		int contained_date_set(int d, Pointer s);

		int contained_date_span(int d, Pointer s);

		int contained_date_spanset(int d, Pointer ss);

		int contained_float_set(double d, Pointer s);

		int contained_float_span(double d, Pointer s);

		int contained_float_spanset(double d, Pointer ss);

		int contained_int_set(int i, Pointer s);

		int contained_int_span(int i, Pointer s);

		int contained_int_spanset(int i, Pointer ss);

		int contained_set_set(Pointer s1, Pointer s2);

		int contained_span_span(Pointer s1, Pointer s2);

		int contained_span_spanset(Pointer s, Pointer ss);

		int contained_spanset_span(Pointer ss, Pointer s);

		int contained_spanset_spanset(Pointer ss1, Pointer ss2);

		int contained_text_set(Pointer txt, Pointer s);

		int contained_timestamptz_set(int t, Pointer s);

		int contained_timestamptz_span(int t, Pointer s);

		int contained_timestamptz_spanset(int t, Pointer ss);

		int contains_set_bigint(Pointer s, int i);

		int contains_set_date(Pointer s, int d);

		int contains_set_float(Pointer s, double d);

		int contains_set_int(Pointer s, int i);

		int contains_set_set(Pointer s1, Pointer s2);

		int contains_set_text(Pointer s, Pointer t);

		int contains_set_timestamptz(Pointer s, int t);

		int contains_span_bigint(Pointer s, int i);

		int contains_span_date(Pointer s, int d);

		int contains_span_float(Pointer s, double d);

		int contains_span_int(Pointer s, int i);

		int contains_span_span(Pointer s1, Pointer s2);

		int contains_span_spanset(Pointer s, Pointer ss);

		int contains_span_timestamptz(Pointer s, int t);

		int contains_spanset_bigint(Pointer ss, int i);

		int contains_spanset_date(Pointer ss, int d);

		int contains_spanset_float(Pointer ss, double d);

		int contains_spanset_int(Pointer ss, int i);

		int contains_spanset_span(Pointer ss, Pointer s);

		int contains_spanset_spanset(Pointer ss1, Pointer ss2);

		int contains_spanset_timestamptz(Pointer ss, int t);

		int overlaps_set_set(Pointer s1, Pointer s2);

		int overlaps_span_span(Pointer s1, Pointer s2);

		int overlaps_span_spanset(Pointer s, Pointer ss);

		int overlaps_spanset_span(Pointer ss, Pointer s);

		int overlaps_spanset_spanset(Pointer ss1, Pointer ss2);

		int after_date_set(int d, Pointer s);

		int after_date_span(int d, Pointer s);

		int after_date_spanset(int d, Pointer ss);

		int after_set_date(Pointer s, int d);

		int after_set_timestamptz(Pointer s, int t);

		int after_span_date(Pointer s, int d);

		int after_span_timestamptz(Pointer s, int t);

		int after_spanset_date(Pointer ss, int d);

		int after_spanset_timestamptz(Pointer ss, int t);

		int after_timestamptz_set(int t, Pointer s);

		int after_timestamptz_span(int t, Pointer s);

		int after_timestamptz_spanset(int t, Pointer ss);

		int before_date_set(int d, Pointer s);

		int before_date_span(int d, Pointer s);

		int before_date_spanset(int d, Pointer ss);

		int before_set_date(Pointer s, int d);

		int before_set_timestamptz(Pointer s, int t);

		int before_span_date(Pointer s, int d);

		int before_span_timestamptz(Pointer s, int t);

		int before_spanset_date(Pointer ss, int d);

		int before_spanset_timestamptz(Pointer ss, int t);

		int before_timestamptz_set(int t, Pointer s);

		int before_timestamptz_span(int t, Pointer s);

		int before_timestamptz_spanset(int t, Pointer ss);

		int left_bigint_set(int i, Pointer s);

		int left_bigint_span(int i, Pointer s);

		int left_bigint_spanset(int i, Pointer ss);

		int left_float_set(double d, Pointer s);

		int left_float_span(double d, Pointer s);

		int left_float_spanset(double d, Pointer ss);

		int left_int_set(int i, Pointer s);

		int left_int_span(int i, Pointer s);

		int left_int_spanset(int i, Pointer ss);

		int left_set_bigint(Pointer s, int i);

		int left_set_float(Pointer s, double d);

		int left_set_int(Pointer s, int i);

		int left_set_set(Pointer s1, Pointer s2);

		int left_set_text(Pointer s, Pointer txt);

		int left_span_bigint(Pointer s, int i);

		int left_span_float(Pointer s, double d);

		int left_span_int(Pointer s, int i);

		int left_span_span(Pointer s1, Pointer s2);

		int left_span_spanset(Pointer s, Pointer ss);

		int left_spanset_bigint(Pointer ss, int i);

		int left_spanset_float(Pointer ss, double d);

		int left_spanset_int(Pointer ss, int i);

		int left_spanset_span(Pointer ss, Pointer s);

		int left_spanset_spanset(Pointer ss1, Pointer ss2);

		int left_text_set(Pointer txt, Pointer s);

		int overafter_date_set(int d, Pointer s);

		int overafter_date_span(int d, Pointer s);

		int overafter_date_spanset(int d, Pointer ss);

		int overafter_set_date(Pointer s, int d);

		int overafter_set_timestamptz(Pointer s, int t);

		int overafter_span_date(Pointer s, int d);

		int overafter_span_timestamptz(Pointer s, int t);

		int overafter_spanset_date(Pointer ss, int d);

		int overafter_spanset_timestamptz(Pointer ss, int t);

		int overafter_timestamptz_set(int t, Pointer s);

		int overafter_timestamptz_span(int t, Pointer s);

		int overafter_timestamptz_spanset(int t, Pointer ss);

		int overbefore_date_set(int d, Pointer s);

		int overbefore_date_span(int d, Pointer s);

		int overbefore_date_spanset(int d, Pointer ss);

		int overbefore_set_date(Pointer s, int d);

		int overbefore_set_timestamptz(Pointer s, int t);

		int overbefore_span_date(Pointer s, int d);

		int overbefore_span_timestamptz(Pointer s, int t);

		int overbefore_spanset_date(Pointer ss, int d);

		int overbefore_spanset_timestamptz(Pointer ss, int t);

		int overbefore_timestamptz_set(int t, Pointer s);

		int overbefore_timestamptz_span(int t, Pointer s);

		int overbefore_timestamptz_spanset(int t, Pointer ss);

		int overleft_bigint_set(int i, Pointer s);

		int overleft_bigint_span(int i, Pointer s);

		int overleft_bigint_spanset(int i, Pointer ss);

		int overleft_float_set(double d, Pointer s);

		int overleft_float_span(double d, Pointer s);

		int overleft_float_spanset(double d, Pointer ss);

		int overleft_int_set(int i, Pointer s);

		int overleft_int_span(int i, Pointer s);

		int overleft_int_spanset(int i, Pointer ss);

		int overleft_set_bigint(Pointer s, int i);

		int overleft_set_float(Pointer s, double d);

		int overleft_set_int(Pointer s, int i);

		int overleft_set_set(Pointer s1, Pointer s2);

		int overleft_set_text(Pointer s, Pointer txt);

		int overleft_span_bigint(Pointer s, int i);

		int overleft_span_float(Pointer s, double d);

		int overleft_span_int(Pointer s, int i);

		int overleft_span_span(Pointer s1, Pointer s2);

		int overleft_span_spanset(Pointer s, Pointer ss);

		int overleft_spanset_bigint(Pointer ss, int i);

		int overleft_spanset_float(Pointer ss, double d);

		int overleft_spanset_int(Pointer ss, int i);

		int overleft_spanset_span(Pointer ss, Pointer s);

		int overleft_spanset_spanset(Pointer ss1, Pointer ss2);

		int overleft_text_set(Pointer txt, Pointer s);

		int overright_bigint_set(int i, Pointer s);

		int overright_bigint_span(int i, Pointer s);

		int overright_bigint_spanset(int i, Pointer ss);

		int overright_float_set(double d, Pointer s);

		int overright_float_span(double d, Pointer s);

		int overright_float_spanset(double d, Pointer ss);

		int overright_int_set(int i, Pointer s);

		int overright_int_span(int i, Pointer s);

		int overright_int_spanset(int i, Pointer ss);

		int overright_set_bigint(Pointer s, int i);

		int overright_set_float(Pointer s, double d);

		int overright_set_int(Pointer s, int i);

		int overright_set_set(Pointer s1, Pointer s2);

		int overright_set_text(Pointer s, Pointer txt);

		int overright_span_bigint(Pointer s, int i);

		int overright_span_float(Pointer s, double d);

		int overright_span_int(Pointer s, int i);

		int overright_span_span(Pointer s1, Pointer s2);

		int overright_span_spanset(Pointer s, Pointer ss);

		int overright_spanset_bigint(Pointer ss, int i);

		int overright_spanset_float(Pointer ss, double d);

		int overright_spanset_int(Pointer ss, int i);

		int overright_spanset_span(Pointer ss, Pointer s);

		int overright_spanset_spanset(Pointer ss1, Pointer ss2);

		int overright_text_set(Pointer txt, Pointer s);

		int right_bigint_set(int i, Pointer s);

		int right_bigint_span(int i, Pointer s);

		int right_bigint_spanset(int i, Pointer ss);

		int right_float_set(double d, Pointer s);

		int right_float_span(double d, Pointer s);

		int right_float_spanset(double d, Pointer ss);

		int right_int_set(int i, Pointer s);

		int right_int_span(int i, Pointer s);

		int right_int_spanset(int i, Pointer ss);

		int right_set_bigint(Pointer s, int i);

		int right_set_float(Pointer s, double d);

		int right_set_int(Pointer s, int i);

		int right_set_set(Pointer s1, Pointer s2);

		int right_set_text(Pointer s, Pointer txt);

		int right_span_bigint(Pointer s, int i);

		int right_span_float(Pointer s, double d);

		int right_span_int(Pointer s, int i);

		int right_span_span(Pointer s1, Pointer s2);

		int right_span_spanset(Pointer s, Pointer ss);

		int right_spanset_bigint(Pointer ss, int i);

		int right_spanset_float(Pointer ss, double d);

		int right_spanset_int(Pointer ss, int i);

		int right_spanset_span(Pointer ss, Pointer s);

		int right_spanset_spanset(Pointer ss1, Pointer ss2);

		int right_text_set(Pointer txt, Pointer s);

		Pointer intersection_bigint_set(int i, Pointer s);
		...
		Pointer intersection_set_bigint(Pointer s, int i);
		...
		Pointer intersection_set_timestamptz(Pointer s, int t);

		Pointer intersection_span_bigint(Pointer s, int i);
		...
		Pointer intersection_span_timestamptz(Pointer s, int t);

		Pointer intersection_spanset_bigint(Pointer ss, int i);
		...
		Pointer intersection_spanset_timestamptz(Pointer ss, int t);

		Pointer intersection_text_set(Pointer txt, Pointer s);

		Pointer intersection_timestamptz_set(int t, Pointer s);

		Pointer minus_bigint_set(int i, Pointer s);

		Pointer minus_bigint_span(int i, Pointer s);

		Pointer minus_bigint_spanset(int i, Pointer ss);
		...
		Pointer minus_set_bigint(Pointer s, int i);
		...
		Pointer minus_set_timestamptz(Pointer s, int t);

		Pointer minus_span_bigint(Pointer s, int i);
		...
		Pointer minus_span_timestamptz(Pointer s, int t);

		Pointer minus_spanset_bigint(Pointer ss, int i);
		...
		Pointer minus_spanset_timestamptz(Pointer ss, int t);

		Pointer minus_text_set(Pointer txt, Pointer s);

		Pointer minus_timestamptz_set(int t, Pointer s);

		Pointer minus_timestamptz_span(int t, Pointer s);

		Pointer minus_timestamptz_spanset(int t, Pointer ss);

		Pointer union_bigint_set(int i, Pointer s);

		Pointer union_bigint_span(Pointer s, int i);

		Pointer union_bigint_spanset(int i, Pointer ss);
		...
		Pointer union_set_bigint(Pointer s, int i);
		...
		Pointer union_set_timestamptz(Pointer s, int t);

		Pointer union_span_bigint(Pointer s, int i);
		...
		Pointer union_span_timestamptz(Pointer s, int t);

		Pointer union_spanset_bigint(Pointer ss, int i);
		...
		Pointer union_spanset_timestamptz(Pointer ss, int t);

		Pointer union_text_set(Pointer txt, Pointer s);

		Pointer union_timestamptz_set(int t, Pointer s);

		Pointer union_timestamptz_span(int t, Pointer s);

		Pointer union_timestamptz_spanset(int t, Pointer ss);

		int distance_bigintset_bigintset(Pointer s1, Pointer s2);

		int distance_bigintspan_bigintspan(Pointer s1, Pointer s2);

		int distance_bigintspanset_bigintspan(Pointer ss, Pointer s);

		int distance_bigintspanset_bigintspanset(Pointer ss1, Pointer ss2);
		...
		int distance_set_bigint(Pointer s, int i);
		...
		double distance_set_timestamptz(Pointer s, int t);

		int distance_span_bigint(Pointer s, int i);
		...
		double distance_span_timestamptz(Pointer s, int t);

		int distance_spanset_bigint(Pointer ss, int i);
		...
		double distance_spanset_timestamptz(Pointer ss, int t);
		...
		Pointer bigint_extent_transfn(Pointer state, int i);

		Pointer bigint_union_transfn(Pointer state, int i);
	...
	public interface MeosLibraryPartB {
		...
		Pointer timestamptz_extent_transfn(Pointer state, int t);

		Pointer timestamptz_union_transfn(Pointer state, int t);

		int bigint_get_bin(int value, int vsize, int vorigin);

		Pointer bigintspan_bins(Pointer s, int vsize, int vorigin, Pointer count);

		Pointer bigintspanset_bins(Pointer ss, int vsize, int vorigin, Pointer count);
		...
		int timestamptz_get_bin(int t, Pointer duration, int torigin);

		Pointer tstzspan_bins(Pointer s, Pointer duration, int origin, Pointer count);

		Pointer tstzspanset_bins(Pointer ss, Pointer duration, int torigin, Pointer count);
		...
		Pointer timestamptz_to_tbox(int t);

		int tbox_hash(Pointer box);

		int tbox_hash_extended(Pointer box, int seed);

		int tbox_hast(Pointer box);

		int tbox_hasx(Pointer box);

		int tbox_tmax(Pointer box, Pointer result);

		int tbox_tmax_inc(Pointer box, Pointer result);

		int tbox_tmin(Pointer box, Pointer result);

		int tbox_tmin_inc(Pointer box, Pointer result);

		int tbox_xmax(Pointer box, Pointer result);

		int tbox_xmax_inc(Pointer box, Pointer result);

		int tbox_xmin(Pointer box, Pointer result);

		int tbox_xmin_inc(Pointer box, Pointer result);

		int tboxfloat_xmax(Pointer box, Pointer result);

		int tboxfloat_xmin(Pointer box, Pointer result);

		int tboxint_xmax(Pointer box, Pointer result);

		int tboxint_xmin(Pointer box, Pointer result);
		...
		Pointer tfloatbox_shift_scale(Pointer box, double shift, double width, int hasshift, int haswidth);

		Pointer tintbox_expand(Pointer box, int i);

		Pointer tintbox_shift_scale(Pointer box, int shift, int width, int hasshift, int haswidth);

		Pointer union_tbox_tbox(Pointer box1, Pointer box2, int strict);

		Pointer intersection_tbox_tbox(Pointer box1, Pointer box2);

		int adjacent_tbox_tbox(Pointer box1, Pointer box2);

		int contained_tbox_tbox(Pointer box1, Pointer box2);

		int contains_tbox_tbox(Pointer box1, Pointer box2);

		int overlaps_tbox_tbox(Pointer box1, Pointer box2);

		int same_tbox_tbox(Pointer box1, Pointer box2);

		int after_tbox_tbox(Pointer box1, Pointer box2);

		int before_tbox_tbox(Pointer box1, Pointer box2);

		int left_tbox_tbox(Pointer box1, Pointer box2);

		int overafter_tbox_tbox(Pointer box1, Pointer box2);

		int overbefore_tbox_tbox(Pointer box1, Pointer box2);

		int overleft_tbox_tbox(Pointer box1, Pointer box2);

		int overright_tbox_tbox(Pointer box1, Pointer box2);

		int right_tbox_tbox(Pointer box1, Pointer box2);

		int tbox_cmp(Pointer box1, Pointer box2);

		int tbox_eq(Pointer box1, Pointer box2);

		int tbox_ge(Pointer box1, Pointer box2);

		int tbox_gt(Pointer box1, Pointer box2);

		int tbox_le(Pointer box1, Pointer box2);

		int tbox_lt(Pointer box1, Pointer box2);

		int tbox_ne(Pointer box1, Pointer box2);
		...
		String temporal_as_mfjson(Pointer temp, int with_bbox, int flags, int precision, String srs);
		...
		Pointer tbool_from_base_temp(int b, Pointer temp);

		Pointer tboolinst_make(int b, int t);

		Pointer tboolseq_from_base_tstzset(int b, Pointer s);

		Pointer tboolseq_from_base_tstzspan(int b, Pointer s);

		Pointer tboolseqset_from_base_tstzspanset(int b, Pointer ss);
		...
		Pointer tsequence_make(Pointer instants, int count, int lower_inc, int upper_inc, int interp, int normalize);

		Pointer tsequenceset_make(Pointer sequences, int count, int normalize);
		...
		int tbool_end_value(Pointer temp);

		int tbool_start_value(Pointer temp);

		int tbool_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value);

		int tbool_value_n(Pointer temp, int n, Pointer result);

		Pointer tbool_values(Pointer temp, Pointer count);

		Pointer temporal_duration(Pointer temp, int boundspan);

		Pointer temporal_end_instant(Pointer temp);

		Pointer temporal_end_sequence(Pointer temp);

		int temporal_end_timestamptz(Pointer temp);
		...
		Pointer temporal_segm_duration(Pointer temp, Pointer duration, int atleast, int strict);
		...
		int temporal_start_timestamptz(Pointer temp);
		...
		int temporal_timestamptz_n(Pointer temp, int n, Pointer result);
		...
		int tfloat_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value);

		int tfloat_value_n(Pointer temp, int n, Pointer result);
		...
		int tint_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value);

		int tint_value_n(Pointer temp, int n, Pointer result);
		...
		int ttext_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value);

		int ttext_value_n(Pointer temp, int n, Pointer result);

		Pointer ttext_values(Pointer temp, Pointer count);

		double float_degrees(double value, int normalize);
		...
		Pointer tfloat_degrees(Pointer temp, int normalize);
		...
		Pointer temporal_append_tinstant(Pointer temp, Pointer inst, int interp, double maxdist, Pointer maxt, int expand);

		Pointer temporal_append_tsequence(Pointer temp, Pointer seq, int expand);

		Pointer temporal_delete_timestamptz(Pointer temp, int t, int connect);

		Pointer temporal_delete_tstzset(Pointer temp, Pointer s, int connect);

		Pointer temporal_delete_tstzspan(Pointer temp, Pointer s, int connect);

		Pointer temporal_delete_tstzspanset(Pointer temp, Pointer ss, int connect);

		Pointer temporal_insert(Pointer temp1, Pointer temp2, int connect);

		Pointer temporal_merge(Pointer temp1, Pointer temp2);

		Pointer temporal_merge_array(Pointer temparr, int count);

		Pointer temporal_update(Pointer temp1, Pointer temp2, int connect);

		Pointer tbool_at_value(Pointer temp, int b);

		Pointer tbool_minus_value(Pointer temp, int b);

		Pointer temporal_after_timestamptz(Pointer temp, int t, int strict);

		Pointer temporal_at_max(Pointer temp);

		Pointer temporal_at_min(Pointer temp);

		Pointer temporal_at_timestamptz(Pointer temp, int t);
		...
		Pointer temporal_before_timestamptz(Pointer temp, int t, int strict);

		Pointer temporal_minus_max(Pointer temp);

		Pointer temporal_minus_min(Pointer temp);

		Pointer temporal_minus_timestamptz(Pointer temp, int t);
		...
		int temporal_eq(Pointer temp1, Pointer temp2);

		int temporal_ge(Pointer temp1, Pointer temp2);

		int temporal_gt(Pointer temp1, Pointer temp2);

		int temporal_le(Pointer temp1, Pointer temp2);

		int temporal_lt(Pointer temp1, Pointer temp2);

		int temporal_ne(Pointer temp1, Pointer temp2);

		int always_eq_bool_tbool(int b, Pointer temp);

		int always_eq_float_tfloat(double d, Pointer temp);

		int always_eq_int_tint(int i, Pointer temp);

		int always_eq_tbool_bool(Pointer temp, int b);
		...
		int adjacent_numspan_tnumber(Pointer s, Pointer temp);

		int adjacent_tbox_tnumber(Pointer box, Pointer temp);

		int adjacent_temporal_temporal(Pointer temp1, Pointer temp2);

		int adjacent_temporal_tstzspan(Pointer temp, Pointer s);

		int adjacent_tnumber_numspan(Pointer temp, Pointer s);

		int adjacent_tnumber_tbox(Pointer temp, Pointer box);

		int adjacent_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int adjacent_tstzspan_temporal(Pointer s, Pointer temp);

		int contained_numspan_tnumber(Pointer s, Pointer temp);

		int contained_tbox_tnumber(Pointer box, Pointer temp);

		int contained_temporal_temporal(Pointer temp1, Pointer temp2);

		int contained_temporal_tstzspan(Pointer temp, Pointer s);

		int contained_tnumber_numspan(Pointer temp, Pointer s);

		int contained_tnumber_tbox(Pointer temp, Pointer box);

		int contained_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int contained_tstzspan_temporal(Pointer s, Pointer temp);

		int contains_numspan_tnumber(Pointer s, Pointer temp);

		int contains_tbox_tnumber(Pointer box, Pointer temp);

		int contains_temporal_tstzspan(Pointer temp, Pointer s);

		int contains_temporal_temporal(Pointer temp1, Pointer temp2);

		int contains_tnumber_numspan(Pointer temp, Pointer s);

		int contains_tnumber_tbox(Pointer temp, Pointer box);

		int contains_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int contains_tstzspan_temporal(Pointer s, Pointer temp);

		int overlaps_numspan_tnumber(Pointer s, Pointer temp);

		int overlaps_tbox_tnumber(Pointer box, Pointer temp);

		int overlaps_temporal_temporal(Pointer temp1, Pointer temp2);

		int overlaps_temporal_tstzspan(Pointer temp, Pointer s);

		int overlaps_tnumber_numspan(Pointer temp, Pointer s);

		int overlaps_tnumber_tbox(Pointer temp, Pointer box);

		int overlaps_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int overlaps_tstzspan_temporal(Pointer s, Pointer temp);

		int same_numspan_tnumber(Pointer s, Pointer temp);

		int same_tbox_tnumber(Pointer box, Pointer temp);

		int same_temporal_temporal(Pointer temp1, Pointer temp2);

		int same_temporal_tstzspan(Pointer temp, Pointer s);

		int same_tnumber_numspan(Pointer temp, Pointer s);

		int same_tnumber_tbox(Pointer temp, Pointer box);

		int same_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int same_tstzspan_temporal(Pointer s, Pointer temp);

		int after_tbox_tnumber(Pointer box, Pointer temp);

		int after_temporal_tstzspan(Pointer temp, Pointer s);

		int after_temporal_temporal(Pointer temp1, Pointer temp2);

		int after_tnumber_tbox(Pointer temp, Pointer box);

		int after_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int after_tstzspan_temporal(Pointer s, Pointer temp);

		int before_tbox_tnumber(Pointer box, Pointer temp);

		int before_temporal_tstzspan(Pointer temp, Pointer s);

		int before_temporal_temporal(Pointer temp1, Pointer temp2);

		int before_tnumber_tbox(Pointer temp, Pointer box);

		int before_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int before_tstzspan_temporal(Pointer s, Pointer temp);

		int left_tbox_tnumber(Pointer box, Pointer temp);

		int left_numspan_tnumber(Pointer s, Pointer temp);

		int left_tnumber_numspan(Pointer temp, Pointer s);

		int left_tnumber_tbox(Pointer temp, Pointer box);

		int left_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int overafter_tbox_tnumber(Pointer box, Pointer temp);

		int overafter_temporal_tstzspan(Pointer temp, Pointer s);

		int overafter_temporal_temporal(Pointer temp1, Pointer temp2);

		int overafter_tnumber_tbox(Pointer temp, Pointer box);

		int overafter_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int overafter_tstzspan_temporal(Pointer s, Pointer temp);

		int overbefore_tbox_tnumber(Pointer box, Pointer temp);

		int overbefore_temporal_tstzspan(Pointer temp, Pointer s);

		int overbefore_temporal_temporal(Pointer temp1, Pointer temp2);

		int overbefore_tnumber_tbox(Pointer temp, Pointer box);

		int overbefore_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int overbefore_tstzspan_temporal(Pointer s, Pointer temp);

		int overleft_numspan_tnumber(Pointer s, Pointer temp);

		int overleft_tbox_tnumber(Pointer box, Pointer temp);

		int overleft_tnumber_numspan(Pointer temp, Pointer s);

		int overleft_tnumber_tbox(Pointer temp, Pointer box);

		int overleft_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int overright_numspan_tnumber(Pointer s, Pointer temp);

		int overright_tbox_tnumber(Pointer box, Pointer temp);

		int overright_tnumber_numspan(Pointer temp, Pointer s);

		int overright_tnumber_tbox(Pointer temp, Pointer box);

		int overright_tnumber_tnumber(Pointer temp1, Pointer temp2);

		int right_numspan_tnumber(Pointer s, Pointer temp);

		int right_tbox_tnumber(Pointer box, Pointer temp);

		int right_tnumber_numspan(Pointer temp, Pointer s);

		int right_tnumber_tbox(Pointer temp, Pointer box);

		int right_tnumber_tnumber(Pointer temp1, Pointer temp2);

		Pointer tand_bool_tbool(int b, Pointer temp);

		Pointer tand_tbool_bool(Pointer temp, int b);
		...
		Pointer tor_bool_tbool(int b, Pointer temp);

		Pointer tor_tbool_bool(Pointer temp, int b);
		...
		Pointer timestamptz_tcount_transfn(Pointer state, int t);
		...
		Pointer temporal_simplify_dp(Pointer temp, double eps_dist, int synchronize);

		Pointer temporal_simplify_max_dist(Pointer temp, double eps_dist, int synchronize);
		...
		Pointer temporal_tprecision(Pointer temp, Pointer duration, int origin);

		Pointer temporal_tsample(Pointer temp, Pointer duration, int origin, int interp);
		...
		Pointer temporal_time_bins(Pointer temp, Pointer duration, int origin, Pointer count);

		Pointer temporal_time_split(Pointer temp, Pointer duration, int torigin, Pointer time_bins, Pointer count);

		Pointer tfloat_time_boxes(Pointer temp, Pointer duration, int torigin, Pointer count);
		...
		Pointer tfloat_value_time_boxes(Pointer temp, double vsize, Pointer duration, double vorigin, int torigin, Pointer count);

		Pointer tfloat_value_time_split(Pointer temp, double vsize, Pointer duration, double vorigin, int torigin, Pointer value_bins, Pointer time_bins, Pointer count);

		Pointer tfloatbox_time_tiles(Pointer box, Pointer duration, int torigin, Pointer count);

		Pointer tfloatbox_value_tiles(Pointer box, double vsize, double vorigin, Pointer count);

		Pointer tfloatbox_value_time_tiles(Pointer box, double vsize, Pointer duration, double vorigin, int torigin, Pointer count);

		Pointer tint_time_boxes(Pointer temp, Pointer duration, int torigin, Pointer count);
		...
		Pointer tint_value_time_boxes(Pointer temp, int vsize, Pointer duration, int vorigin, int torigin, Pointer count);

		Pointer tint_value_time_split(Pointer temp, long size, Pointer duration, int vorigin, int torigin, Pointer value_bins, Pointer time_bins, Pointer count);

		Pointer tintbox_time_tiles(Pointer box, Pointer duration, int torigin, Pointer count);

		Pointer tintbox_value_tiles(Pointer box, int xsize, int xorigin, Pointer count);

		Pointer tintbox_value_time_tiles(Pointer box, int xsize, Pointer duration, int xorigin, int torigin, Pointer count);
		...
		Pointer gbox_make(int hasz, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax);
		...
		int geo_is_empty(Pointer g);

		int geo_is_unitary(Pointer gs);

		String geo_typename(int type);

		double geog_area(Pointer g, int use_spheroid);

		Pointer geog_centroid(Pointer g, int use_spheroid);

		double geog_length(Pointer g, int use_spheroid);

		double geog_perimeter(Pointer g, int use_spheroid);

		int geom_azimuth(Pointer gs1, Pointer gs2, Pointer result);
		...
		Pointer geo_transform_pipeline(Pointer gs, String pipeline, int srid_to, int is_forward);
		...
		Pointer line_interpolate_point(Pointer gs, double distance_fraction, int repeat);

		double line_locate_point(Pointer gs1, Pointer gs2);

		Pointer line_substring(Pointer gs, double from, double to);

		int geog_dwithin(Pointer g1, Pointer g2, double tolerance, int use_spheroid);

		int geog_intersects(Pointer gs1, Pointer gs2, int use_spheroid);

		int geom_contains(Pointer gs1, Pointer gs2);

		int geom_covers(Pointer gs1, Pointer gs2);

		int geom_disjoint2d(Pointer gs1, Pointer gs2);

		int geom_dwithin2d(Pointer gs1, Pointer gs2, double tolerance);

	}

	public interface MeosLibraryPartC {

		int geom_dwithin3d(Pointer gs1, Pointer gs2, double tolerance);

		int geom_intersects2d(Pointer gs1, Pointer gs2);

		int geom_intersects3d(Pointer gs1, Pointer gs2);

		int geom_relate_pattern(Pointer gs1, Pointer gs2, String patt);

		int geom_touches(Pointer gs1, Pointer gs2);
		...
		int geo_same(Pointer gs1, Pointer gs2);
		...
		int geoset_value_n(Pointer s, int n, Pointer result);

		Pointer geoset_values(Pointer s);

		int contained_geo_set(Pointer gs, Pointer s);

		int contains_set_geo(Pointer s, Pointer gs);
		...
		Pointer spatialset_transform_pipeline(Pointer s, String pipelinestr, int srid, int is_forward);
		...
		Pointer geo_timestamptz_to_stbox(Pointer gs, int t);

		Pointer geo_tstzspan_to_stbox(Pointer gs, Pointer s);

		Pointer stbox_copy(Pointer box);

		Pointer stbox_make(int hasx, int hasz, int geodetic, int srid, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax, Pointer s);
		...
		Pointer timestamptz_to_stbox(int t);
		...
		double stbox_area(Pointer box, int spheroid);

		int stbox_hash(Pointer box);

		int stbox_hash_extended(Pointer box, int seed);

		int stbox_hast(Pointer box);

		int stbox_hasx(Pointer box);

		int stbox_hasz(Pointer box);

		int stbox_isgeodetic(Pointer box);

		double stbox_perimeter(Pointer box, int spheroid);

		int stbox_tmax(Pointer box, Pointer result);

		int stbox_tmax_inc(Pointer box, Pointer result);

		int stbox_tmin(Pointer box, Pointer result);

		int stbox_tmin_inc(Pointer box, Pointer result);

		double stbox_volume(Pointer box);

		int stbox_xmax(Pointer box, Pointer result);

		int stbox_xmin(Pointer box, Pointer result);

		int stbox_ymax(Pointer box, Pointer result);

		int stbox_ymin(Pointer box, Pointer result);

		int stbox_zmax(Pointer box, Pointer result);

		int stbox_zmin(Pointer box, Pointer result);
		...
		Pointer stbox_transform_pipeline(Pointer box, String pipelinestr, int srid, int is_forward);

		int adjacent_stbox_stbox(Pointer box1, Pointer box2);

		int contained_stbox_stbox(Pointer box1, Pointer box2);

		int contains_stbox_stbox(Pointer box1, Pointer box2);

		int overlaps_stbox_stbox(Pointer box1, Pointer box2);

		int same_stbox_stbox(Pointer box1, Pointer box2);

		int above_stbox_stbox(Pointer box1, Pointer box2);

		int after_stbox_stbox(Pointer box1, Pointer box2);

		int back_stbox_stbox(Pointer box1, Pointer box2);

		int before_stbox_stbox(Pointer box1, Pointer box2);

		int below_stbox_stbox(Pointer box1, Pointer box2);

		int front_stbox_stbox(Pointer box1, Pointer box2);

		int left_stbox_stbox(Pointer box1, Pointer box2);

		int overabove_stbox_stbox(Pointer box1, Pointer box2);

		int overafter_stbox_stbox(Pointer box1, Pointer box2);

		int overback_stbox_stbox(Pointer box1, Pointer box2);

		int overbefore_stbox_stbox(Pointer box1, Pointer box2);

		int overbelow_stbox_stbox(Pointer box1, Pointer box2);

		int overfront_stbox_stbox(Pointer box1, Pointer box2);

		int overleft_stbox_stbox(Pointer box1, Pointer box2);

		int overright_stbox_stbox(Pointer box1, Pointer box2);

		int right_stbox_stbox(Pointer box1, Pointer box2);

		Pointer union_stbox_stbox(Pointer box1, Pointer box2, int strict);

		Pointer intersection_stbox_stbox(Pointer box1, Pointer box2);

		int stbox_cmp(Pointer box1, Pointer box2);

		int stbox_eq(Pointer box1, Pointer box2);

		int stbox_ge(Pointer box1, Pointer box2);

		int stbox_gt(Pointer box1, Pointer box2);

		int stbox_le(Pointer box1, Pointer box2);

		int stbox_lt(Pointer box1, Pointer box2);

		int stbox_ne(Pointer box1, Pointer box2);
		...
		Pointer tgeoinst_make(Pointer gs, int t);
		...
		Pointer tpointinst_make(Pointer gs, int t);
		...
		Pointer tpointseq_make_coords(Pointer xcoords, Pointer ycoords, Pointer zcoords, Pointer times, int count, int srid, int geodetic, int lower_inc, int upper_inc, int interp, int normalize);
		...
		int tpoint_as_mvtgeom(Pointer temp, Pointer bounds, int extent, int buffer, int clip_geom, Pointer gsarr, Pointer timesarr, Pointer count);

		int tpoint_tfloat_to_geomeas(Pointer tpoint, Pointer measure, int segmentize, Pointer result);

		Pointer tspatial_to_stbox(Pointer temp);

		int bearing_point_point(Pointer gs1, Pointer gs2, Pointer result);

		Pointer bearing_tpoint_point(Pointer temp, Pointer gs, int invert);
		...
		Pointer tgeo_traversed_area(Pointer temp, int unary_union);

		int tgeo_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value);

		int tgeo_value_n(Pointer temp, int n, Pointer result);
		...
		int tpoint_direction(Pointer temp, Pointer result);
		...
		int tpoint_is_simple(Pointer temp);

		double tpoint_length(Pointer temp);

		Pointer tpoint_speed(Pointer temp);

		Pointer tpoint_trajectory(Pointer temp, int unary_union);
		...
		Pointer tspatial_transform_pipeline(Pointer temp, String pipelinestr, int srid, int is_forward);

		Pointer tgeo_at_geom(Pointer temp, Pointer gs);

		Pointer tgeo_at_stbox(Pointer temp, Pointer box, int border_inc);

		Pointer tgeo_at_value(Pointer temp, Pointer gs);

		Pointer tgeo_minus_geom(Pointer temp, Pointer gs);

		Pointer tgeo_minus_stbox(Pointer temp, Pointer box, int border_inc);
		...
		Pointer tgeo_space_boxes(Pointer temp, double xsize, double ysize, double zsize, Pointer sorigin, int bitmatrix, int border_inc, Pointer count);

		Pointer tgeo_space_time_boxes(Pointer temp, double xsize, double ysize, double zsize, Pointer duration, Pointer sorigin, int torigin, int bitmatrix, int border_inc, Pointer count);
		...
		int adjacent_stbox_tspatial(Pointer box, Pointer temp);

		int adjacent_tspatial_stbox(Pointer temp, Pointer box);

		int adjacent_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int contained_stbox_tspatial(Pointer box, Pointer temp);

		int contained_tspatial_stbox(Pointer temp, Pointer box);

		int contained_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int contains_stbox_tspatial(Pointer box, Pointer temp);

		int contains_tspatial_stbox(Pointer temp, Pointer box);

		int contains_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int overlaps_stbox_tspatial(Pointer box, Pointer temp);

		int overlaps_tspatial_stbox(Pointer temp, Pointer box);

		int overlaps_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int same_stbox_tspatial(Pointer box, Pointer temp);

		int same_tspatial_stbox(Pointer temp, Pointer box);

		int same_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int above_stbox_tspatial(Pointer box, Pointer temp);

		int above_tspatial_stbox(Pointer temp, Pointer box);

		int above_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int after_stbox_tspatial(Pointer box, Pointer temp);

		int after_tspatial_stbox(Pointer temp, Pointer box);

		int after_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int back_stbox_tspatial(Pointer box, Pointer temp);

		int back_tspatial_stbox(Pointer temp, Pointer box);

		int back_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int before_stbox_tspatial(Pointer box, Pointer temp);

		int before_tspatial_stbox(Pointer temp, Pointer box);

		int before_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int below_stbox_tspatial(Pointer box, Pointer temp);

		int below_tspatial_stbox(Pointer temp, Pointer box);

		int below_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int front_stbox_tspatial(Pointer box, Pointer temp);

		int front_tspatial_stbox(Pointer temp, Pointer box);

		int front_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int left_stbox_tspatial(Pointer box, Pointer temp);

		int left_tspatial_stbox(Pointer temp, Pointer box);

		int left_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int overabove_stbox_tspatial(Pointer box, Pointer temp);

		int overabove_tspatial_stbox(Pointer temp, Pointer box);

		int overabove_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int overafter_stbox_tspatial(Pointer box, Pointer temp);

		int overafter_tspatial_stbox(Pointer temp, Pointer box);

		int overafter_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int overback_stbox_tspatial(Pointer box, Pointer temp);

		int overback_tspatial_stbox(Pointer temp, Pointer box);

		int overback_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int overbefore_stbox_tspatial(Pointer box, Pointer temp);

		int overbefore_tspatial_stbox(Pointer temp, Pointer box);

		int overbefore_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int overbelow_stbox_tspatial(Pointer box, Pointer temp);

		int overbelow_tspatial_stbox(Pointer temp, Pointer box);

		int overbelow_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int overfront_stbox_tspatial(Pointer box, Pointer temp);

		int overfront_tspatial_stbox(Pointer temp, Pointer box);

		int overfront_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int overleft_stbox_tspatial(Pointer box, Pointer temp);

		int overleft_tspatial_stbox(Pointer temp, Pointer box);

		int overleft_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int overright_stbox_tspatial(Pointer box, Pointer temp);

		int overright_tspatial_stbox(Pointer temp, Pointer box);

		int overright_tspatial_tspatial(Pointer temp1, Pointer temp2);

		int right_stbox_tspatial(Pointer box, Pointer temp);

		int right_tspatial_stbox(Pointer temp, Pointer box);

		int right_tspatial_tspatial(Pointer temp1, Pointer temp2);
		...
		Pointer stbox_get_space_time_tile(Pointer point, int t, double xsize, double ysize, double zsize, Pointer duration, Pointer sorigin, int torigin);

		Pointer stbox_get_time_tile(int t, Pointer duration, int torigin);

		Pointer stbox_space_tiles(Pointer bounds, double xsize, double ysize, double zsize, Pointer sorigin, int border_inc, Pointer count);

		Pointer stbox_space_time_tiles(Pointer bounds, double xsize, double ysize, double zsize, Pointer duration, Pointer sorigin, int torigin, int border_inc, Pointer count);

		Pointer stbox_time_tiles(Pointer bounds, Pointer duration, int torigin, int border_inc, Pointer count);

		Pointer tgeo_space_split(Pointer temp, double xsize, double ysize, double zsize, Pointer sorigin, int bitmatrix, int border_inc, Pointer space_bins, Pointer count);

		Pointer tgeo_space_time_split(Pointer temp, double xsize, double ysize, double zsize, Pointer duration, Pointer sorigin, int torigin, int bitmatrix, int border_inc, Pointer space_bins, Pointer time_bins, Pointer count);
		...
		Pointer cbuffer_transform_pipeline(Pointer cb, String pipelinestr, int srid, int is_forward);
		...
		Pointer cbuffer_timestamptz_to_stbox(Pointer cb, int t);
		...
		int cbuffer_eq(Pointer cb1, Pointer cb2);

		int cbuffer_ge(Pointer cb1, Pointer cb2);

		int cbuffer_gt(Pointer cb1, Pointer cb2);

		int cbuffer_le(Pointer cb1, Pointer cb2);

		int cbuffer_lt(Pointer cb1, Pointer cb2);

		int cbuffer_ne(Pointer cb1, Pointer cb2);

		int cbuffer_nsame(Pointer cb1, Pointer cb2);

		int cbuffer_same(Pointer cb1, Pointer cb2);
		...
		int cbufferset_value_n(Pointer s, int n, Pointer result);

		Pointer cbufferset_values(Pointer s);

		Pointer cbuffer_union_transfn(Pointer state, Pointer cb);

		int contained_cbuffer_set(Pointer cb, Pointer s);

		int contains_set_cbuffer(Pointer s, Pointer cb);
		...
		Pointer tcbufferinst_make(Pointer cb, int t);

		Pointer tcbuffer_make(Pointer tpoint, Pointer tfloat);

		Pointer tcbuffer_from_base_temp(Pointer cb, Pointer temp);

		Pointer tcbufferseq_from_base_tstzset(Pointer cb, Pointer s);

		Pointer tcbufferseq_from_base_tstzspan(Pointer cb, Pointer s, int interp);

		Pointer tcbufferseqset_from_base_tstzspanset(Pointer cb, Pointer ss, int interp);

		Pointer tcbuffer_end_value(Pointer temp);

		Pointer tcbuffer_points(Pointer temp);

		Pointer tcbuffer_radius(Pointer temp);

		Pointer tcbuffer_start_value(Pointer temp);

		Pointer tcbuffer_trav_area(Pointer temp, int merge_union);

		int tcbuffer_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value);

		int tcbuffer_value_n(Pointer temp, int n, Pointer result);

		Pointer tcbuffer_values(Pointer temp, Pointer count);
		...
		Pointer tcbuffer_at_stbox(Pointer temp, Pointer box, int border_inc);

		Pointer tcbuffer_minus_cbuffer(Pointer temp, Pointer cb);

		Pointer tcbuffer_minus_geom(Pointer temp, Pointer gs);

		Pointer tcbuffer_minus_stbox(Pointer temp, Pointer box, int border_inc);
		...
		Pointer set_make(Pointer values, int count, int basetype, int order);

		Pointer set_make_exp(Pointer values, int count, int maxcount, int basetype, int order);

		Pointer set_make_free(Pointer values, int count, int basetype, int order);

		Pointer span_make(Pointer lower, Pointer upper, int lower_inc, int upper_inc, int basetype);

		void span_set(Pointer lower, Pointer upper, int lower_inc, int upper_inc, int basetype, int spantype, Pointer s);

		Pointer spanset_make_exp(Pointer spans, int count, int maxcount, int normalize, int order);

		Pointer spanset_make_free(Pointer spans, int count, int normalize, int order);
		...
		int numspanset_width(Pointer ss, int boundspan);
		...
		int set_value_n(Pointer s, int n, Pointer result);
		...
		Pointer numset_shift_scale(Pointer s, Pointer shift, Pointer width, int hasshift, int haswidth);

		Pointer numspan_expand(Pointer s, Pointer value);

		Pointer numspan_shift_scale(Pointer s, Pointer shift, Pointer width, int hasshift, int haswidth);

		Pointer numspanset_shift_scale(Pointer ss, Pointer shift, Pointer width, int hasshift, int haswidth);
		...
		Pointer textcat_textset_text_common(Pointer s, Pointer txt, int invert);

		void tstzspan_set_datespan(Pointer s1, Pointer s2);

		int adjacent_span_value(Pointer s, Pointer value);

		int adjacent_spanset_value(Pointer ss, Pointer value);

		int adjacent_value_spanset(Pointer value, Pointer ss);

		int contained_value_set(Pointer value, Pointer s);

		int contained_value_span(Pointer value, Pointer s);

		int contained_value_spanset(Pointer value, Pointer ss);

		int contains_set_value(Pointer s, Pointer value);

		int contains_span_value(Pointer s, Pointer value);

		int contains_spanset_value(Pointer ss, Pointer value);

		int ovadj_span_span(Pointer s1, Pointer s2);

		int left_set_value(Pointer s, Pointer value);

		int left_span_value(Pointer s, Pointer value);

		int left_spanset_value(Pointer ss, Pointer value);

		int left_value_set(Pointer value, Pointer s);

		int left_value_span(Pointer value, Pointer s);

		int left_value_spanset(Pointer value, Pointer ss);

		int lfnadj_span_span(Pointer s1, Pointer s2);

		int overleft_set_value(Pointer s, Pointer value);

		int overleft_span_value(Pointer s, Pointer value);

		int overleft_spanset_value(Pointer ss, Pointer value);

		int overleft_value_set(Pointer value, Pointer s);

		int overleft_value_span(Pointer value, Pointer s);

		int overleft_value_spanset(Pointer value, Pointer ss);

		int overright_set_value(Pointer s, Pointer value);

		int overright_span_value(Pointer s, Pointer value);

		int overright_spanset_value(Pointer ss, Pointer value);

		int overright_value_set(Pointer value, Pointer s);

		int overright_value_span(Pointer value, Pointer s);

		int overright_value_spanset(Pointer value, Pointer ss);

		int right_value_set(Pointer value, Pointer s);

		int right_set_value(Pointer s, Pointer value);

		int right_value_span(Pointer value, Pointer s);

		int right_value_spanset(Pointer value, Pointer ss);

		int right_span_value(Pointer s, Pointer value);

		int right_spanset_value(Pointer ss, Pointer value);

		int bbox_type(int bboxtype);

		int bbox_get_size(int bboxtype);

		int bbox_max_dims(int bboxtype);

		int temporal_bbox_eq(Pointer box1, Pointer box2, int temptype);
		...
		int inter_span_span(Pointer s1, Pointer s2, Pointer result);
		...
		Pointer number_timestamptz_to_tbox(Pointer d, int basetype, int t);
		...
		void timestamptz_set_tbox(int t, Pointer box);

		void tstzset_set_tbox(Pointer s, Pointer box);

		void tstzspan_set_tbox(Pointer s, Pointer box);

		Pointer tbox_shift_scale_value(Pointer box, Pointer shift, Pointer width, int hasshift, int haswidth);
	...
	public interface MeosLibraryPartD {
		...
		int inter_tbox_tbox(Pointer box1, Pointer box2, Pointer result);
		...
		Pointer tinstant_from_mfjson(Pointer mfjson, int spatial, int srid, int temptype);
		...
		Pointer tsequence_from_mfjson(Pointer mfjson, int spatial, int srid, int temptype, int interp);

		Pointer tsequence_in(String str, int temptype, int interp);

		String tsequence_out(Pointer seq, int maxdd);

		Pointer tsequenceset_from_mfjson(Pointer mfjson, int spatial, int srid, int temptype, int interp);
		...
		Pointer tinstant_make(Pointer value, int temptype, int t);

		Pointer tinstant_make_free(Pointer value, int temptype, int t);
		...
		Pointer tsequence_make_exp(Pointer instants, int count, int maxcount, int lower_inc, int upper_inc, int interp, int normalize);

		Pointer tsequence_make_free(Pointer instants, int count, int lower_inc, int upper_inc, int interp, int normalize);
		...
		Pointer tsequenceset_make_exp(Pointer sequences, int count, int maxcount, int normalize);

		Pointer tsequenceset_make_free(Pointer sequences, int count, int normalize);
		...
		int temporal_value_n(Pointer temp, int n, Pointer result);
		...
		int tinstant_value_at_timestamptz(Pointer inst, int t, Pointer result);
		...
		int tsequence_end_timestamptz(Pointer seq);
		...
		int tsequence_start_timestamptz(Pointer seq);

		Pointer tsequence_time(Pointer seq);

		Pointer tsequence_timestamps(Pointer seq, Pointer count);

		int tsequence_value_at_timestamptz(Pointer seq, int t, int strict, Pointer result);

		Pointer tsequence_values_p(Pointer seq, Pointer count);

		Pointer tsequenceset_duration(Pointer ss, int boundspan);

		int tsequenceset_end_timestamptz(Pointer ss);
		...
		int tsequenceset_start_timestamptz(Pointer ss);

		Pointer tsequenceset_time(Pointer ss);

		int tsequenceset_timestamptz_n(Pointer ss, int n, Pointer result);

		Pointer tsequenceset_timestamps(Pointer ss, Pointer count);

		int tsequenceset_value_at_timestamptz(Pointer ss, int t, int strict, Pointer result);

		int tsequenceset_value_n(Pointer ss, int n, Pointer result);
		...
		Pointer tnumber_shift_scale_value(Pointer temp, Pointer shift, Pointer width, int hasshift, int haswidth);

		Pointer tnumberinst_shift_value(Pointer inst, Pointer shift);

		Pointer tnumberseq_shift_scale_value(Pointer seq, Pointer shift, Pointer width, int hasshift, int haswidth);

		Pointer tnumberseqset_shift_scale_value(Pointer ss, Pointer start, Pointer width, int hasshift, int haswidth);
		...
		Pointer tsequence_subseq(Pointer seq, int from, int to, int lower_inc, int upper_inc);
		...
		Pointer tsequence_append_tinstant(Pointer seq, Pointer inst, double maxdist, Pointer maxt, int expand);

		Pointer tsequence_append_tsequence(Pointer seq1, Pointer seq2, int expand);

		Pointer tsequence_delete_timestamptz(Pointer seq, int t, int connect);

		Pointer tsequence_delete_tstzset(Pointer seq, Pointer s, int connect);

		Pointer tsequence_delete_tstzspan(Pointer seq, Pointer s, int connect);

		Pointer tsequence_delete_tstzspanset(Pointer seq, Pointer ss, int connect);

		Pointer tsequence_insert(Pointer seq1, Pointer seq2, int connect);

		Pointer tsequence_merge(Pointer seq1, Pointer seq2);

		Pointer tsequence_merge_array(Pointer sequences, int count);

		Pointer tsequenceset_append_tinstant(Pointer ss, Pointer inst, double maxdist, Pointer maxt, int expand);

		Pointer tsequenceset_append_tsequence(Pointer ss, Pointer seq, int expand);

		Pointer tsequenceset_delete_timestamptz(Pointer ss, int t);
		...
		Pointer tcontseq_after_timestamptz(Pointer seq, int t, int strict);

		Pointer tcontseq_before_timestamptz(Pointer seq, int t, int strict);

		Pointer tcontseq_restrict_minmax(Pointer seq, int min, int atfunc);

		Pointer tdiscseq_after_timestamptz(Pointer seq, int t, int strict);

		Pointer tdiscseq_before_timestamptz(Pointer seq, int t, int strict);

		Pointer tdiscseq_restrict_minmax(Pointer seq, int min, int atfunc);

		int temporal_bbox_restrict_set(Pointer temp, Pointer set);

		Pointer temporal_restrict_minmax(Pointer temp, int min, int atfunc);

		Pointer temporal_restrict_timestamptz(Pointer temp, int t, int atfunc);

		Pointer temporal_restrict_tstzset(Pointer temp, Pointer s, int atfunc);

		Pointer temporal_restrict_tstzspan(Pointer temp, Pointer s, int atfunc);

		Pointer temporal_restrict_tstzspanset(Pointer temp, Pointer ss, int atfunc);

		Pointer temporal_restrict_value(Pointer temp, Pointer value, int atfunc);

		Pointer temporal_restrict_values(Pointer temp, Pointer set, int atfunc);

		int temporal_value_at_timestamptz(Pointer temp, int t, int strict, Pointer result);

		Pointer tinstant_after_timestamptz(Pointer inst, int t, int strict);

		Pointer tinstant_before_timestamptz(Pointer inst, int t, int strict);

		Pointer tinstant_restrict_tstzspan(Pointer inst, Pointer period, int atfunc);

		Pointer tinstant_restrict_tstzspanset(Pointer inst, Pointer ss, int atfunc);

		Pointer tinstant_restrict_timestamptz(Pointer inst, int t, int atfunc);

		Pointer tinstant_restrict_tstzset(Pointer inst, Pointer s, int atfunc);

		Pointer tinstant_restrict_value(Pointer inst, Pointer value, int atfunc);

		Pointer tinstant_restrict_values(Pointer inst, Pointer set, int atfunc);

		Pointer tnumber_restrict_span(Pointer temp, Pointer span, int atfunc);

		Pointer tnumber_restrict_spanset(Pointer temp, Pointer ss, int atfunc);

		Pointer tnumberinst_restrict_span(Pointer inst, Pointer span, int atfunc);

		Pointer tnumberinst_restrict_spanset(Pointer inst, Pointer ss, int atfunc);

		Pointer tnumberseqset_restrict_span(Pointer ss, Pointer span, int atfunc);

		Pointer tnumberseqset_restrict_spanset(Pointer ss, Pointer spanset, int atfunc);

		Pointer tsequence_at_timestamptz(Pointer seq, int t);

		Pointer tsequence_restrict_tstzspan(Pointer seq, Pointer s, int atfunc);

		Pointer tsequence_restrict_tstzspanset(Pointer seq, Pointer ss, int atfunc);

		Pointer tsequenceset_after_timestamptz(Pointer ss, int t, int strict);

		Pointer tsequenceset_before_timestamptz(Pointer ss, int t, int strict);

		Pointer tsequenceset_restrict_minmax(Pointer ss, int min, int atfunc);

		Pointer tsequenceset_restrict_tstzspan(Pointer ss, Pointer s, int atfunc);

		Pointer tsequenceset_restrict_tstzspanset(Pointer ss, Pointer ps, int atfunc);

		Pointer tsequenceset_restrict_timestamptz(Pointer ss, int t, int atfunc);

		Pointer tsequenceset_restrict_tstzset(Pointer ss, Pointer s, int atfunc);

		Pointer tsequenceset_restrict_value(Pointer ss, Pointer value, int atfunc);

		Pointer tsequenceset_restrict_values(Pointer ss, Pointer s, int atfunc);

		int tinstant_cmp(Pointer inst1, Pointer inst2);

		int tinstant_eq(Pointer inst1, Pointer inst2);

		int tsequence_cmp(Pointer seq1, Pointer seq2);

		int tsequence_eq(Pointer seq1, Pointer seq2);

		int tsequenceset_cmp(Pointer ss1, Pointer ss2);

		int tsequenceset_eq(Pointer ss1, Pointer ss2);
		...
		void skiplist_splice(Pointer list, Pointer keys, Pointer values, int count, Pointer func, int crossings, int sktype);

		void temporal_skiplist_splice(Pointer list, Pointer values, int count, Pointer func, int crossings);
		...
		Pointer tnumber_value_time_boxes(Pointer temp, Pointer vsize, Pointer duration, Pointer vorigin, int torigin, Pointer count);

		Pointer tnumber_value_split(Pointer temp, Pointer vsize, Pointer vorigin, Pointer bins, Pointer count);

		Pointer tbox_get_value_time_tile(Pointer value, int t, Pointer vsize, Pointer duration, Pointer vorigin, int torigin, int basetype, int spantype);

		Pointer tnumber_value_time_split(Pointer temp, Pointer size, Pointer duration, Pointer vorigin, int torigin, Pointer value_bins, Pointer time_bins, Pointer count);
		...
		void stbox_set(int hasx, int hasz, int geodetic, int srid, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax, Pointer s, Pointer box);

		void gbox_set_stbox(Pointer box, int srid, Pointer result);

		int geo_set_stbox(Pointer gs, Pointer box);

		void geoarr_set_stbox(Pointer values, int count, Pointer box);

		int spatial_set_stbox(Pointer d, int basetype, Pointer box);
		...
		int inter_stbox_stbox(Pointer box1, Pointer box2, Pointer result);
		...
		Pointer tgeo_restrict_elevation(Pointer temp, Pointer s, int atfunc);

		Pointer tgeo_restrict_geom(Pointer temp, Pointer gs, int atfunc);

		Pointer tgeo_restrict_stbox(Pointer temp, Pointer box, int border_inc, int atfunc);

		Pointer tgeoinst_restrict_geom(Pointer inst, Pointer gs, int atfunc);

		Pointer tgeoinst_restrict_stbox(Pointer inst, Pointer box, int border_inc, int atfunc);

		Pointer tgeoseq_restrict_geom(Pointer seq, Pointer gs, int atfunc);

		Pointer tgeoseq_restrict_stbox(Pointer seq, Pointer box, int border_inc, int atfunc);

		Pointer tgeoseqset_restrict_geom(Pointer ss, Pointer gs, int atfunc);

		Pointer tgeoseqset_restrict_stbox(Pointer ss, Pointer box, int border_inc, int atfunc);

		int spatial_srid(Pointer d, int basetype);

		int spatial_set_srid(Pointer d, int basetype, int srid);
		...
		int tpointseq_is_simple(Pointer seq);

		double tpointseq_length(Pointer seq);

		Pointer tpointseq_linear_trajectory(Pointer seq, int unary_union);
		...
		int tpointseqset_is_simple(Pointer ss);
		...
		Pointer tgeominst_tgeoginst(Pointer inst, int oper);

		Pointer tgeomseq_tgeogseq(Pointer seq, int oper);

		Pointer tgeomseqset_tgeogseqset(Pointer ss, int oper);

		Pointer tgeom_tgeog(Pointer temp, int oper);

		Pointer tgeo_tpoint(Pointer temp, int oper);
		...
		Pointer npoint_make(int rid, double pos);

		Pointer nsegment_make(int rid, double pos1, double pos2);
		...
		int npoint_route(Pointer np);

		double nsegment_end_position(Pointer ns);

		int nsegment_route(Pointer ns);

		double nsegment_start_position(Pointer ns);

		int route_exists(int rid);

		Pointer route_geom(int rid);

		double route_length(int rid);
		...
		Pointer npoint_timestamptz_to_stbox(Pointer np, int t);

		Pointer npoint_tstzspan_to_stbox(Pointer np, Pointer s);

		int npoint_cmp(Pointer np1, Pointer np2);

		int npoint_eq(Pointer np1, Pointer np2);

		int npoint_ge(Pointer np1, Pointer np2);

		int npoint_gt(Pointer np1, Pointer np2);

		int npoint_le(Pointer np1, Pointer np2);

		int npoint_lt(Pointer np1, Pointer np2);

		int npoint_ne(Pointer np1, Pointer np2);

		int npoint_same(Pointer np1, Pointer np2);

		int nsegment_cmp(Pointer ns1, Pointer ns2);

		int nsegment_eq(Pointer ns1, Pointer ns2);

		int nsegment_ge(Pointer ns1, Pointer ns2);

		int nsegment_gt(Pointer ns1, Pointer ns2);

		int nsegment_le(Pointer ns1, Pointer ns2);

		int nsegment_lt(Pointer ns1, Pointer ns2);

		int nsegment_ne(Pointer ns1, Pointer ns2);
		...
		int npointset_value_n(Pointer s, int n, Pointer result);

		Pointer npointset_values(Pointer s);

		int contained_npoint_set(Pointer np, Pointer s);

		int contains_set_npoint(Pointer s, Pointer np);
		...
		Pointer tnpointinst_make(Pointer np, int t);

		Pointer tnpoint_from_base_temp(Pointer np, Pointer temp);

		Pointer tnpointseq_from_base_tstzset(Pointer np, Pointer s);

		Pointer tnpointseq_from_base_tstzspan(Pointer np, Pointer s, int interp);

		Pointer tnpointseqset_from_base_tstzspanset(Pointer np, Pointer ss, int interp);
		...
		Pointer tnpoint_end_value(Pointer temp);

		double tnpoint_length(Pointer temp);

		Pointer tnpoint_positions(Pointer temp, Pointer count);

		int tnpoint_route(Pointer temp);

		Pointer tnpoint_routes(Pointer temp);

		Pointer tnpoint_speed(Pointer temp);

		Pointer tnpoint_start_value(Pointer temp);

		Pointer tnpoint_trajectory(Pointer temp);

		int tnpoint_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value);

		int tnpoint_value_n(Pointer temp, int n, Pointer result);

		Pointer tnpoint_values(Pointer temp, Pointer count);
		...
		Pointer tnpoint_at_stbox(Pointer temp, Pointer box, int border_inc);
		...
		Pointer tnpoint_minus_stbox(Pointer temp, Pointer box, int border_inc);
		...
		Pointer pose_transform_pipeline(Pointer pose, String pipelinestr, int srid, int is_forward);

		Pointer pose_tstzspan_to_stbox(Pointer pose, Pointer s);

		Pointer pose_timestamptz_to_stbox(Pointer pose, int t);
		...
		int pose_eq(Pointer pose1, Pointer pose2);

		int pose_ge(Pointer pose1, Pointer pose2);

		int pose_gt(Pointer pose1, Pointer pose2);

		int pose_le(Pointer pose1, Pointer pose2);

		int pose_lt(Pointer pose1, Pointer pose2);

		int pose_ne(Pointer pose1, Pointer pose2);

		int pose_nsame(Pointer pose1, Pointer pose2);

		int pose_same(Pointer pose1, Pointer pose2);
		...
		int poseset_value_n(Pointer s, int n, Pointer result);

		Pointer poseset_values(Pointer s);

		int contained_pose_set(Pointer pose, Pointer s);

		int contains_set_pose(Pointer s, Pointer pose);
		...
		Pointer tpose_from_mfjson(String str);

		Pointer tpose_in(String str);

		Pointer tposeinst_make(Pointer pose, int t);

		Pointer tpose_from_base_temp(Pointer pose, Pointer temp);

		Pointer tposeseq_from_base_tstzset(Pointer pose, Pointer s);

		Pointer tposeseq_from_base_tstzspan(Pointer pose, Pointer s, int interp);

		Pointer tposeseqset_from_base_tstzspanset(Pointer pose, Pointer ss, int interp);
		...
		int tpose_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value);

		int tpose_value_n(Pointer temp, int n, Pointer result);

		Pointer tpose_values(Pointer temp, Pointer count);

		Pointer tpose_at_geom(Pointer temp, Pointer gs);

		Pointer tpose_at_stbox(Pointer temp, Pointer box, int border_inc);
		...
		Pointer tpose_minus_stbox(Pointer temp, Pointer box, int border_inc);
		...
		Pointer trgeoinst_make(Pointer geom, Pointer pose, int t);
		...
		int trgeo_value_n(Pointer temp, int n, Pointer result);

		Pointer trgeo_traversed_area(Pointer temp, int unary_union);

		Pointer trgeo_append_tinstant(Pointer temp, Pointer inst, int interp, double maxdist, Pointer maxt, int expand);

		Pointer trgeo_append_tsequence(Pointer temp, Pointer seq, int expand);

		Pointer trgeo_delete_timestamptz(Pointer temp, int t, int connect);

		Pointer trgeo_delete_tstzset(Pointer temp, Pointer s, int connect);

		Pointer trgeo_delete_tstzspan(Pointer temp, Pointer s, int connect);

		Pointer trgeo_delete_tstzspanset(Pointer temp, Pointer ss, int connect);
		...
		Pointer trgeo_after_timestamptz(Pointer temp, int t, int strict);

		Pointer trgeo_before_timestamptz(Pointer temp, int t, int strict);

		Pointer trgeo_restrict_value(Pointer temp, Pointer value, int atfunc);

		Pointer trgeo_restrict_values(Pointer temp, Pointer s, int atfunc);

		Pointer trgeo_restrict_timestamptz(Pointer temp, int t, int atfunc);

		Pointer trgeo_restrict_tstzset(Pointer temp, Pointer s, int atfunc);

		Pointer trgeo_restrict_tstzspan(Pointer temp, Pointer s, int atfunc);

		Pointer trgeo_restrict_tstzspanset(Pointer temp, Pointer ss, int atfunc);
	...
	@SuppressWarnings("unused")
	public static int meos_set_datestyle(String newval, Pointer extra) {
	...
	@SuppressWarnings("unused")
	public static int add_timestamptz_interval(int t, Pointer interv) {
		var _result = _meos_a.add_timestamptz_interval(t, interv);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int minus_timestamptz_interval(int t, Pointer interv) {
		var _result = _meos_a.minus_timestamptz_interval(t, interv);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer minus_timestamptz_timestamptz(int t1, int t2) {
		var _result = _meos_a.minus_timestamptz_timestamptz(t1, t2);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static String pg_timestamp_out(int t) {
		var _result = _meos_a.pg_timestamp_out(t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static String pg_timestamptz_out(int t) {
		var _result = _meos_a.pg_timestamptz_out(t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int timestamptz_shift(int t, Pointer interv) {
		var _result = _meos_a.timestamptz_shift(t, interv);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int timestamp_to_date(int t) {
		var _result = _meos_a.timestamp_to_date(t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int timestamptz_to_date(int t) {
		var _result = _meos_a.timestamptz_to_date(t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer bigintspan_expand(Pointer s, int value) {
	...
	@SuppressWarnings("unused")
	public static Pointer bigintspan_make(int lower, int upper, int lower_inc, int upper_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer datespan_make(int lower, int upper, int lower_inc, int upper_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer floatspan_make(double lower, double upper, int lower_inc, int upper_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer intspan_make(int lower, int upper, int lower_inc, int upper_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tstzspan_make(int lower, int upper, int lower_inc, int upper_inc) {
		var _result = _meos_a.tstzspan_make(lower, upper, lower_inc, upper_inc);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer bigint_to_set(int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer timestamptz_to_set(int t) {
		var _result = _meos_a.timestamptz_to_set(t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer timestamptz_to_span(int t) {
		var _result = _meos_a.timestamptz_to_span(t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer timestamptz_to_spanset(int t) {
		var _result = _meos_a.timestamptz_to_spanset(t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int bigintset_end_value(Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int bigintset_start_value(Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int bigintset_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_a.bigintset_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int bigintspan_width(Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int bigintspanset_width(Pointer ss, int boundspan) {
	...
	@SuppressWarnings("unused")
	public static int dateset_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_a.dateset_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int datespanset_date_n(Pointer ss, int n, Pointer result) {
		var _result = _meos_a.datespanset_date_n(ss, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer datespanset_duration(Pointer ss, int boundspan) {
	...
	@SuppressWarnings("unused")
	public static int floatset_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_a.floatset_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static double floatspanset_width(Pointer ss, int boundspan) {
	...
	@SuppressWarnings("unused")
	public static int intset_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_a.intset_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int intspanset_width(Pointer ss, int boundspan) {
	...
	@SuppressWarnings("unused")
	public static int span_hash_extended(Pointer s, int seed) {
	...
	@SuppressWarnings("unused")
	public static int span_lower_inc(Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int span_upper_inc(Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int spanset_lower_inc(Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int spanset_upper_inc(Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int textset_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_a.textset_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tstzset_end_value(Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int tstzset_start_value(Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int tstzset_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_a.tstzset_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tstzspan_lower(Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int tstzspan_upper(Pointer s) {
	...
	@SuppressWarnings("unused")
	public static Pointer tstzspanset_duration(Pointer ss, int boundspan) {
	...
	@SuppressWarnings("unused")
	public static int tstzspanset_end_timestamptz(Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int tstzspanset_lower(Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int tstzspanset_start_timestamptz(Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int tstzspanset_timestamptz_n(Pointer ss, int n, Pointer result) {
		var _result = _meos_a.tstzspanset_timestamptz_n(ss, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tstzspanset_upper(Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static Pointer bigintset_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer bigintspan_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer bigintspanset_shift_scale(Pointer ss, int shift, int width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer dateset_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer datespan_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer datespanset_shift_scale(Pointer ss, int shift, int width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer floatset_degrees(Pointer s, int normalize) {
	...
	@SuppressWarnings("unused")
	public static Pointer floatset_shift_scale(Pointer s, double shift, double width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer floatspan_degrees(Pointer s, int normalize) {
	...
	@SuppressWarnings("unused")
	public static Pointer floatspan_shift_scale(Pointer s, double shift, double width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer floatspanset_degrees(Pointer ss, int normalize) {
	...
	@SuppressWarnings("unused")
	public static Pointer floatspanset_shift_scale(Pointer ss, double shift, double width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer intset_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer intspan_shift_scale(Pointer s, int shift, int width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer intspanset_shift_scale(Pointer ss, int shift, int width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static int timestamptz_tprecision(int t, Pointer duration, int torigin) {
		var _result = _meos_a.timestamptz_tprecision(t, duration, torigin);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tstzset_tprecision(Pointer s, Pointer duration, int torigin) {
		var _result = _meos_a.tstzset_tprecision(s, duration, torigin);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tstzspan_tprecision(Pointer s, Pointer duration, int torigin) {
		var _result = _meos_a.tstzspan_tprecision(s, duration, torigin);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tstzspanset_tprecision(Pointer ss, Pointer duration, int torigin) {
		var _result = _meos_a.tstzspanset_tprecision(ss, duration, torigin);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int set_eq(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int set_ge(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int set_gt(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int set_le(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int set_lt(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int set_ne(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int span_eq(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int span_ge(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int span_gt(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int span_le(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int span_lt(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int span_ne(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int spanset_eq(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int spanset_ge(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int spanset_gt(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int spanset_le(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int spanset_lt(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int spanset_ne(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_span_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_span_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_span_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_span_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_span_span(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_span_spanset(Pointer s, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_span_timestamptz(Pointer s, int t) {
		var _result = _meos_a.adjacent_span_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int adjacent_spanset_bigint(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_spanset_date(Pointer ss, int d) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_spanset_float(Pointer ss, double d) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_spanset_int(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_spanset_timestamptz(Pointer ss, int t) {
		var _result = _meos_a.adjacent_spanset_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int adjacent_spanset_span(Pointer ss, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_spanset_spanset(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int contained_bigint_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_bigint_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_bigint_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int contained_date_set(int d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_date_span(int d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_date_spanset(int d, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int contained_float_set(double d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_float_span(double d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_float_spanset(double d, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int contained_int_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_int_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_int_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int contained_set_set(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int contained_span_span(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int contained_span_spanset(Pointer s, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int contained_spanset_span(Pointer ss, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_spanset_spanset(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int contained_text_set(Pointer txt, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_timestamptz_set(int t, Pointer s) {
		var _result = _meos_a.contained_timestamptz_set(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int contained_timestamptz_span(int t, Pointer s) {
		var _result = _meos_a.contained_timestamptz_span(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int contained_timestamptz_spanset(int t, Pointer ss) {
		var _result = _meos_a.contained_timestamptz_spanset(t, ss);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int contains_set_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_set(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_text(Pointer s, Pointer t) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_timestamptz(Pointer s, int t) {
		var _result = _meos_a.contains_set_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int contains_span_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int contains_span_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int contains_span_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int contains_span_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int contains_span_span(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int contains_span_spanset(Pointer s, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int contains_span_timestamptz(Pointer s, int t) {
		var _result = _meos_a.contains_span_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int contains_spanset_bigint(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int contains_spanset_date(Pointer ss, int d) {
	...
	@SuppressWarnings("unused")
	public static int contains_spanset_float(Pointer ss, double d) {
	...
	@SuppressWarnings("unused")
	public static int contains_spanset_int(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int contains_spanset_span(Pointer ss, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contains_spanset_spanset(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int contains_spanset_timestamptz(Pointer ss, int t) {
		var _result = _meos_a.contains_spanset_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overlaps_set_set(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_span_span(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_span_spanset(Pointer s, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_spanset_span(Pointer ss, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_spanset_spanset(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int after_date_set(int d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int after_date_span(int d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int after_date_spanset(int d, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int after_set_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int after_set_timestamptz(Pointer s, int t) {
		var _result = _meos_a.after_set_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int after_span_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int after_span_timestamptz(Pointer s, int t) {
		var _result = _meos_a.after_span_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int after_spanset_date(Pointer ss, int d) {
	...
	@SuppressWarnings("unused")
	public static int after_spanset_timestamptz(Pointer ss, int t) {
		var _result = _meos_a.after_spanset_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int after_timestamptz_set(int t, Pointer s) {
		var _result = _meos_a.after_timestamptz_set(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int after_timestamptz_span(int t, Pointer s) {
		var _result = _meos_a.after_timestamptz_span(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int after_timestamptz_spanset(int t, Pointer ss) {
		var _result = _meos_a.after_timestamptz_spanset(t, ss);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int before_date_set(int d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int before_date_span(int d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int before_date_spanset(int d, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int before_set_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int before_set_timestamptz(Pointer s, int t) {
		var _result = _meos_a.before_set_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int before_span_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int before_span_timestamptz(Pointer s, int t) {
		var _result = _meos_a.before_span_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int before_spanset_date(Pointer ss, int d) {
	...
	@SuppressWarnings("unused")
	public static int before_spanset_timestamptz(Pointer ss, int t) {
		var _result = _meos_a.before_spanset_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int before_timestamptz_set(int t, Pointer s) {
		var _result = _meos_a.before_timestamptz_set(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int before_timestamptz_span(int t, Pointer s) {
		var _result = _meos_a.before_timestamptz_span(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int before_timestamptz_spanset(int t, Pointer ss) {
		var _result = _meos_a.before_timestamptz_spanset(t, ss);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int left_bigint_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int left_bigint_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int left_bigint_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int left_float_set(double d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int left_float_span(double d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int left_float_spanset(double d, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int left_int_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int left_int_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int left_int_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int left_set_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int left_set_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int left_set_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int left_set_set(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int left_set_text(Pointer s, Pointer txt) {
	...
	@SuppressWarnings("unused")
	public static int left_span_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int left_span_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int left_span_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int left_span_span(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int left_span_spanset(Pointer s, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int left_spanset_bigint(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int left_spanset_float(Pointer ss, double d) {
	...
	@SuppressWarnings("unused")
	public static int left_spanset_int(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int left_spanset_span(Pointer ss, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int left_spanset_spanset(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int left_text_set(Pointer txt, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overafter_date_set(int d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overafter_date_span(int d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overafter_date_spanset(int d, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overafter_set_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int overafter_set_timestamptz(Pointer s, int t) {
		var _result = _meos_a.overafter_set_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overafter_span_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int overafter_span_timestamptz(Pointer s, int t) {
		var _result = _meos_a.overafter_span_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overafter_spanset_date(Pointer ss, int d) {
	...
	@SuppressWarnings("unused")
	public static int overafter_spanset_timestamptz(Pointer ss, int t) {
		var _result = _meos_a.overafter_spanset_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overafter_timestamptz_set(int t, Pointer s) {
		var _result = _meos_a.overafter_timestamptz_set(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overafter_timestamptz_span(int t, Pointer s) {
		var _result = _meos_a.overafter_timestamptz_span(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overafter_timestamptz_spanset(int t, Pointer ss) {
		var _result = _meos_a.overafter_timestamptz_spanset(t, ss);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overbefore_date_set(int d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_date_span(int d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_date_spanset(int d, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_set_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_set_timestamptz(Pointer s, int t) {
		var _result = _meos_a.overbefore_set_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overbefore_span_date(Pointer s, int d) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_span_timestamptz(Pointer s, int t) {
		var _result = _meos_a.overbefore_span_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overbefore_spanset_date(Pointer ss, int d) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_spanset_timestamptz(Pointer ss, int t) {
		var _result = _meos_a.overbefore_spanset_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overbefore_timestamptz_set(int t, Pointer s) {
		var _result = _meos_a.overbefore_timestamptz_set(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overbefore_timestamptz_span(int t, Pointer s) {
		var _result = _meos_a.overbefore_timestamptz_span(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overbefore_timestamptz_spanset(int t, Pointer ss) {
		var _result = _meos_a.overbefore_timestamptz_spanset(t, ss);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int overleft_bigint_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overleft_bigint_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overleft_bigint_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overleft_float_set(double d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overleft_float_span(double d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overleft_float_spanset(double d, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overleft_int_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overleft_int_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overleft_int_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overleft_set_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int overleft_set_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int overleft_set_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int overleft_set_set(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int overleft_set_text(Pointer s, Pointer txt) {
	...
	@SuppressWarnings("unused")
	public static int overleft_span_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int overleft_span_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int overleft_span_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int overleft_span_span(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int overleft_span_spanset(Pointer s, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overleft_spanset_bigint(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int overleft_spanset_float(Pointer ss, double d) {
	...
	@SuppressWarnings("unused")
	public static int overleft_spanset_int(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int overleft_spanset_span(Pointer ss, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overleft_spanset_spanset(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int overleft_text_set(Pointer txt, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_bigint_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_bigint_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_bigint_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overright_float_set(double d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_float_span(double d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_float_spanset(double d, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overright_int_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_int_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_int_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overright_set_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int overright_set_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int overright_set_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int overright_set_set(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int overright_set_text(Pointer s, Pointer txt) {
	...
	@SuppressWarnings("unused")
	public static int overright_span_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int overright_span_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int overright_span_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int overright_span_span(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int overright_span_spanset(Pointer s, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overright_spanset_bigint(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int overright_spanset_float(Pointer ss, double d) {
	...
	@SuppressWarnings("unused")
	public static int overright_spanset_int(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int overright_spanset_span(Pointer ss, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_spanset_spanset(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int overright_text_set(Pointer txt, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int right_bigint_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int right_bigint_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int right_bigint_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int right_float_set(double d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int right_float_span(double d, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int right_float_spanset(double d, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int right_int_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int right_int_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int right_int_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int right_set_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int right_set_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int right_set_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int right_set_set(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int right_set_text(Pointer s, Pointer txt) {
	...
	@SuppressWarnings("unused")
	public static int right_span_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int right_span_float(Pointer s, double d) {
	...
	@SuppressWarnings("unused")
	public static int right_span_int(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static int right_span_span(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int right_span_spanset(Pointer s, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int right_spanset_bigint(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int right_spanset_float(Pointer ss, double d) {
	...
	@SuppressWarnings("unused")
	public static int right_spanset_int(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static int right_spanset_span(Pointer ss, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int right_spanset_spanset(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int right_text_set(Pointer txt, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static Pointer intersection_bigint_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static Pointer intersection_set_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer intersection_set_timestamptz(Pointer s, int t) {
		var _result = _meos_a.intersection_set_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer intersection_span_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer intersection_span_timestamptz(Pointer s, int t) {
		var _result = _meos_a.intersection_span_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer intersection_spanset_bigint(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer intersection_spanset_timestamptz(Pointer ss, int t) {
		var _result = _meos_a.intersection_spanset_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer intersection_timestamptz_set(int t, Pointer s) {
		var _result = _meos_a.intersection_timestamptz_set(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer minus_bigint_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static Pointer minus_bigint_span(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static Pointer minus_bigint_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static Pointer minus_set_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer minus_set_timestamptz(Pointer s, int t) {
		var _result = _meos_a.minus_set_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer minus_span_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer minus_span_timestamptz(Pointer s, int t) {
		var _result = _meos_a.minus_span_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer minus_spanset_bigint(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer minus_spanset_timestamptz(Pointer ss, int t) {
		var _result = _meos_a.minus_spanset_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer minus_timestamptz_set(int t, Pointer s) {
		var _result = _meos_a.minus_timestamptz_set(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer minus_timestamptz_span(int t, Pointer s) {
		var _result = _meos_a.minus_timestamptz_span(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer minus_timestamptz_spanset(int t, Pointer ss) {
		var _result = _meos_a.minus_timestamptz_spanset(t, ss);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer union_bigint_set(int i, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static Pointer union_bigint_span(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer union_bigint_spanset(int i, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static Pointer union_set_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer union_set_timestamptz(Pointer s, int t) {
		var _result = _meos_a.union_set_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer union_span_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer union_span_timestamptz(Pointer s, int t) {
		var _result = _meos_a.union_span_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer union_spanset_bigint(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer union_spanset_timestamptz(Pointer ss, int t) {
		var _result = _meos_a.union_spanset_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer union_timestamptz_set(int t, Pointer s) {
		var _result = _meos_a.union_timestamptz_set(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer union_timestamptz_span(int t, Pointer s) {
		var _result = _meos_a.union_timestamptz_span(t, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer union_timestamptz_spanset(int t, Pointer ss) {
		var _result = _meos_a.union_timestamptz_spanset(t, ss);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int distance_bigintset_bigintset(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int distance_bigintspan_bigintspan(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int distance_bigintspanset_bigintspan(Pointer ss, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int distance_bigintspanset_bigintspanset(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static int distance_set_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static double distance_set_timestamptz(Pointer s, int t) {
		var _result = _meos_a.distance_set_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int distance_span_bigint(Pointer s, int i) {
	...
	@SuppressWarnings("unused")
	public static double distance_span_timestamptz(Pointer s, int t) {
		var _result = _meos_a.distance_span_timestamptz(s, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int distance_spanset_bigint(Pointer ss, int i) {
	...
	@SuppressWarnings("unused")
	public static double distance_spanset_timestamptz(Pointer ss, int t) {
		var _result = _meos_a.distance_spanset_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer bigint_extent_transfn(Pointer state, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer bigint_union_transfn(Pointer state, int i) {
	...
	@SuppressWarnings("unused")
	public static Pointer timestamptz_extent_transfn(Pointer state, int t) {
		var _result = _meos_b.timestamptz_extent_transfn(state, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer timestamptz_union_transfn(Pointer state, int t) {
		var _result = _meos_b.timestamptz_union_transfn(state, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer bigintspan_bins(Pointer s, int vsize, int vorigin, Pointer count) {
	...
	@SuppressWarnings("unused")
	public static Pointer bigintspanset_bins(Pointer ss, int vsize, int vorigin, Pointer count) {
	...
	@SuppressWarnings("unused")
	public static int timestamptz_get_bin(int t, Pointer duration, int torigin) {
		var _result = _meos_b.timestamptz_get_bin(t, duration, torigin);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tstzspan_bins(Pointer s, Pointer duration, int origin, Pointer count) {
		var _result = _meos_b.tstzspan_bins(s, duration, origin, count);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tstzspanset_bins(Pointer ss, Pointer duration, int torigin, Pointer count) {
		var _result = _meos_b.tstzspanset_bins(ss, duration, torigin, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer float_timestamptz_to_tbox(double d, int t) {
		var _result = _meos_b.float_timestamptz_to_tbox(d, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer int_timestamptz_to_tbox(int i, int t) {
		var _result = _meos_b.int_timestamptz_to_tbox(i, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer numspan_timestamptz_to_tbox(Pointer span, int t) {
		var _result = _meos_b.numspan_timestamptz_to_tbox(span, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer timestamptz_to_tbox(int t) {
		var _result = _meos_b.timestamptz_to_tbox(t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tbox_hast(Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int tbox_hasx(Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int tbox_tmax(Pointer box, Pointer result) {
		var _result = _meos_b.tbox_tmax(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tbox_tmax_inc(Pointer box, Pointer result) {
		var _result = _meos_b.tbox_tmax_inc(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tbox_tmin(Pointer box, Pointer result) {
		var _result = _meos_b.tbox_tmin(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tbox_tmin_inc(Pointer box, Pointer result) {
		var _result = _meos_b.tbox_tmin_inc(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tbox_xmax(Pointer box, Pointer result) {
		var _result = _meos_b.tbox_xmax(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tbox_xmax_inc(Pointer box, Pointer result) {
		var _result = _meos_b.tbox_xmax_inc(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tbox_xmin(Pointer box, Pointer result) {
		var _result = _meos_b.tbox_xmin(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tbox_xmin_inc(Pointer box, Pointer result) {
		var _result = _meos_b.tbox_xmin_inc(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tboxfloat_xmax(Pointer box, Pointer result) {
		var _result = _meos_b.tboxfloat_xmax(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tboxfloat_xmin(Pointer box, Pointer result) {
		var _result = _meos_b.tboxfloat_xmin(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tboxint_xmax(Pointer box, Pointer result) {
		var _result = _meos_b.tboxint_xmax(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tboxint_xmin(Pointer box, Pointer result) {
		var _result = _meos_b.tboxint_xmin(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tfloatbox_shift_scale(Pointer box, double shift, double width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer tintbox_shift_scale(Pointer box, int shift, int width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer union_tbox_tbox(Pointer box1, Pointer box2, int strict) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int contained_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int contains_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int same_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int after_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int before_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int left_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overafter_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overleft_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overright_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int right_tbox_tbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int tbox_eq(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int tbox_ge(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int tbox_gt(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int tbox_le(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int tbox_lt(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int tbox_ne(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static String temporal_as_mfjson(Pointer temp, int with_bbox, int flags, int precision, String srs) {
	...
	@SuppressWarnings("unused")
	public static Pointer tbool_from_base_temp(int b, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer tboolinst_make(int b, int t) {
		var _result = _meos_b.tboolinst_make(b, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tboolseq_from_base_tstzset(int b, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static Pointer tboolseq_from_base_tstzspan(int b, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static Pointer tboolseqset_from_base_tstzspanset(int b, Pointer ss) {
	...
	public static Pointer tfloatinst_make(double d, int t) {
		var _result = _meos_b.tfloatinst_make(d, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer tintinst_make(int i, int t) {
		var _result = _meos_b.tintinst_make(i, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_make(Pointer instants, int count, int lower_inc, int upper_inc, int interp, int normalize) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_make(Pointer sequences, int count, int normalize) {
	...
	public static Pointer ttextinst_make(Pointer txt, int t) {
		var _result = _meos_b.ttextinst_make(txt, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tbool_end_value(Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int tbool_start_value(Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int tbool_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value) {
		var _result = _meos_b.tbool_value_at_timestamptz(temp, t, strict, value);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tbool_value_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_b.tbool_value_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_duration(Pointer temp, int boundspan) {
	...
	@SuppressWarnings("unused")
	public static int temporal_end_timestamptz(Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_segm_duration(Pointer temp, Pointer duration, int atleast, int strict) {
	...
	@SuppressWarnings("unused")
	public static int temporal_start_timestamptz(Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int temporal_timestamptz_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_b.temporal_timestamptz_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tfloat_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value) {
		var _result = _meos_b.tfloat_value_at_timestamptz(temp, t, strict, value);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tfloat_value_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_b.tfloat_value_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tint_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value) {
		var _result = _meos_b.tint_value_at_timestamptz(temp, t, strict, value);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tint_value_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_b.tint_value_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int ttext_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value) {
		var _result = _meos_b.ttext_value_at_timestamptz(temp, t, strict, value);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int ttext_value_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_b.ttext_value_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tfloat_degrees(Pointer temp, int normalize) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_append_tinstant(Pointer temp, Pointer inst, int interp, double maxdist, Pointer maxt, int expand) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_append_tsequence(Pointer temp, Pointer seq, int expand) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_delete_timestamptz(Pointer temp, int t, int connect) {
		var _result = _meos_b.temporal_delete_timestamptz(temp, t, connect);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer temporal_delete_tstzset(Pointer temp, Pointer s, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_delete_tstzspan(Pointer temp, Pointer s, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_delete_tstzspanset(Pointer temp, Pointer ss, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_insert(Pointer temp1, Pointer temp2, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_update(Pointer temp1, Pointer temp2, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer tbool_at_value(Pointer temp, int b) {
	...
	@SuppressWarnings("unused")
	public static Pointer tbool_minus_value(Pointer temp, int b) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_after_timestamptz(Pointer temp, int t, int strict) {
		var _result = _meos_b.temporal_after_timestamptz(temp, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_at_timestamptz(Pointer temp, int t) {
		var _result = _meos_b.temporal_at_timestamptz(temp, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_before_timestamptz(Pointer temp, int t, int strict) {
		var _result = _meos_b.temporal_before_timestamptz(temp, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_minus_timestamptz(Pointer temp, int t) {
		var _result = _meos_b.temporal_minus_timestamptz(temp, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int temporal_eq(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int temporal_ge(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int temporal_gt(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int temporal_le(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int temporal_lt(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int temporal_ne(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int always_eq_bool_tbool(int b, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int always_eq_tbool_bool(Pointer temp, int b) {
	...
	@SuppressWarnings("unused")
	public static int always_ne_bool_tbool(int b, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int always_ne_tbool_bool(Pointer temp, int b) {
	...
	@SuppressWarnings("unused")
	public static int ever_eq_bool_tbool(int b, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int ever_eq_tbool_bool(Pointer temp, int b) {
	...
	@SuppressWarnings("unused")
	public static int ever_ne_bool_tbool(int b, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int ever_ne_tbool_bool(Pointer temp, int b) {
	...
	@SuppressWarnings("unused")
	public static Pointer teq_bool_tbool(int b, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer teq_tbool_bool(Pointer temp, int b) {
	...
	@SuppressWarnings("unused")
	public static Pointer tne_bool_tbool(int b, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer tne_tbool_bool(Pointer temp, int b) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_numspan_tnumber(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_temporal_temporal(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_temporal_tstzspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_tnumber_numspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_tstzspan_temporal(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int contained_numspan_tnumber(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int contained_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int contained_temporal_temporal(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int contained_temporal_tstzspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_tnumber_numspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int contained_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int contained_tstzspan_temporal(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int contains_numspan_tnumber(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int contains_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int contains_temporal_tstzspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contains_temporal_temporal(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int contains_tnumber_numspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contains_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int contains_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int contains_tstzspan_temporal(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_numspan_tnumber(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_temporal_temporal(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_temporal_tstzspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_tnumber_numspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_tstzspan_temporal(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int same_numspan_tnumber(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int same_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int same_temporal_temporal(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int same_temporal_tstzspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int same_tnumber_numspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int same_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int same_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int same_tstzspan_temporal(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int after_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int after_temporal_tstzspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int after_temporal_temporal(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int after_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int after_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int after_tstzspan_temporal(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int before_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int before_temporal_tstzspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int before_temporal_temporal(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int before_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int before_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int before_tstzspan_temporal(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int left_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int left_numspan_tnumber(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int left_tnumber_numspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int left_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int left_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overafter_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overafter_temporal_tstzspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overafter_temporal_temporal(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overafter_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overafter_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overafter_tstzspan_temporal(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_temporal_tstzspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_temporal_temporal(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_tstzspan_temporal(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overleft_numspan_tnumber(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overleft_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overleft_tnumber_numspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overleft_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overleft_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overright_numspan_tnumber(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overright_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overright_tnumber_numspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overright_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int right_numspan_tnumber(Pointer s, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int right_tbox_tnumber(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int right_tnumber_numspan(Pointer temp, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int right_tnumber_tbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int right_tnumber_tnumber(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static Pointer tand_bool_tbool(int b, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer tand_tbool_bool(Pointer temp, int b) {
	...
	@SuppressWarnings("unused")
	public static Pointer tor_bool_tbool(int b, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer tor_tbool_bool(Pointer temp, int b) {
	...
	public static Pointer mult_float_tfloat(double d, Pointer tnumber) {
		var _result = _meos_b.mult_float_tfloat(d, tnumber);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer mult_int_tint(int i, Pointer tnumber) {
		var _result = _meos_b.mult_int_tint(i, tnumber);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer mult_tfloat_float(Pointer tnumber, double d) {
		var _result = _meos_b.mult_tfloat_float(tnumber, d);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer mult_tint_int(Pointer tnumber, int i) {
		var _result = _meos_b.mult_tint_int(tnumber, i);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer mult_tnumber_tnumber(Pointer tnumber1, Pointer tnumber2) {
		var _result = _meos_b.mult_tnumber_tnumber(tnumber1, tnumber2);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer timestamptz_tcount_transfn(Pointer state, int t) {
		var _result = _meos_b.timestamptz_tcount_transfn(state, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_simplify_dp(Pointer temp, double eps_dist, int synchronize) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_simplify_max_dist(Pointer temp, double eps_dist, int synchronize) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_tprecision(Pointer temp, Pointer duration, int origin) {
		var _result = _meos_b.temporal_tprecision(temp, duration, origin);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer temporal_tsample(Pointer temp, Pointer duration, int origin, int interp) {
		var _result = _meos_b.temporal_tsample(temp, duration, origin, interp);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_time_bins(Pointer temp, Pointer duration, int origin, Pointer count) {
		var _result = _meos_b.temporal_time_bins(temp, duration, origin, count);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer temporal_time_split(Pointer temp, Pointer duration, int torigin, Pointer time_bins, Pointer count) {
		var _result = _meos_b.temporal_time_split(temp, duration, torigin, time_bins, count);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tfloat_time_boxes(Pointer temp, Pointer duration, int torigin, Pointer count) {
		var _result = _meos_b.tfloat_time_boxes(temp, duration, torigin, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tfloat_value_time_boxes(Pointer temp, double vsize, Pointer duration, double vorigin, int torigin, Pointer count) {
		var _result = _meos_b.tfloat_value_time_boxes(temp, vsize, duration, vorigin, torigin, count);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tfloat_value_time_split(Pointer temp, double vsize, Pointer duration, double vorigin, int torigin, Pointer value_bins, Pointer time_bins, Pointer count) {
		var _result = _meos_b.tfloat_value_time_split(temp, vsize, duration, vorigin, torigin, value_bins, time_bins, count);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tfloatbox_time_tiles(Pointer box, Pointer duration, int torigin, Pointer count) {
		var _result = _meos_b.tfloatbox_time_tiles(box, duration, torigin, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tfloatbox_value_time_tiles(Pointer box, double vsize, Pointer duration, double vorigin, int torigin, Pointer count) {
		var _result = _meos_b.tfloatbox_value_time_tiles(box, vsize, duration, vorigin, torigin, count);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tint_time_boxes(Pointer temp, Pointer duration, int torigin, Pointer count) {
		var _result = _meos_b.tint_time_boxes(temp, duration, torigin, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tint_value_time_boxes(Pointer temp, int vsize, Pointer duration, int vorigin, int torigin, Pointer count) {
		var _result = _meos_b.tint_value_time_boxes(temp, vsize, duration, vorigin, torigin, count);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tint_value_time_split(Pointer temp, long size, Pointer duration, int vorigin, int torigin, Pointer value_bins, Pointer time_bins, Pointer count) {
		var _result = _meos_b.tint_value_time_split(temp, size, duration, vorigin, torigin, value_bins, time_bins, count);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tintbox_time_tiles(Pointer box, Pointer duration, int torigin, Pointer count) {
		var _result = _meos_b.tintbox_time_tiles(box, duration, torigin, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tintbox_value_time_tiles(Pointer box, int xsize, Pointer duration, int xorigin, int torigin, Pointer count) {
		var _result = _meos_b.tintbox_value_time_tiles(box, xsize, duration, xorigin, torigin, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer gbox_make(int hasz, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax) {
	...
	@SuppressWarnings("unused")
	public static int geo_is_empty(Pointer g) {
		var _result = _meos_b.geo_is_empty(g);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int geo_is_unitary(Pointer gs) {
		var _result = _meos_b.geo_is_unitary(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static String geo_typename(int type) {
		var _result = _meos_b.geo_typename(type);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static double geog_area(Pointer g, int use_spheroid) {
		var _result = _meos_b.geog_area(g, use_spheroid);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer geog_centroid(Pointer g, int use_spheroid) {
		var _result = _meos_b.geog_centroid(g, use_spheroid);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static double geog_length(Pointer g, int use_spheroid) {
		var _result = _meos_b.geog_length(g, use_spheroid);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static double geog_perimeter(Pointer g, int use_spheroid) {
		var _result = _meos_b.geog_perimeter(g, use_spheroid);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int geom_azimuth(Pointer gs1, Pointer gs2, Pointer result) {
		var _result = _meos_b.geom_azimuth(gs1, gs2, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static double geom_length(Pointer gs) {
		var _result = _meos_b.geom_length(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static double geom_perimeter(Pointer gs) {
		var _result = _meos_b.geom_perimeter(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int line_numpoints(Pointer gs) {
		var _result = _meos_b.line_numpoints(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer line_point_n(Pointer geom, int n) {
		var _result = _meos_b.line_point_n(geom, n);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geo_reverse(Pointer gs) {
		var _result = _meos_b.geo_reverse(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geo_round(Pointer gs, int maxdd) {
		var _result = _meos_b.geo_round(gs, maxdd);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geo_set_srid(Pointer gs, int srid) {
		var _result = _meos_b.geo_set_srid(gs, srid);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int geo_srid(Pointer gs) {
		var _result = _meos_b.geo_srid(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geo_transform(Pointer geom, int srid_to) {
		var _result = _meos_b.geo_transform(geom, srid_to);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer geo_transform_pipeline(Pointer gs, String pipeline, int srid_to, int is_forward) {
		var _result = _meos_b.geo_transform_pipeline(gs, pipeline, srid_to, is_forward);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geo_collect_garray(Pointer gsarr, int count) {
		var _result = _meos_b.geo_collect_garray(gsarr, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geo_makeline_garray(Pointer gsarr, int count) {
		var _result = _meos_b.geo_makeline_garray(gsarr, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int geo_num_points(Pointer gs) {
		var _result = _meos_b.geo_num_points(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int geo_num_geos(Pointer gs) {
		var _result = _meos_b.geo_num_geos(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geo_geo_n(Pointer geom, int n) {
		var _result = _meos_b.geo_geo_n(geom, n);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geo_pointarr(Pointer gs, Pointer count) {
		var _result = _meos_b.geo_pointarr(gs, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geo_points(Pointer gs) {
		var _result = _meos_b.geo_points(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_array_union(Pointer gsarr, int count) {
		var _result = _meos_b.geom_array_union(gsarr, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_boundary(Pointer gs) {
		var _result = _meos_b.geom_boundary(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_buffer(Pointer gs, double size, String params) {
		var _result = _meos_b.geom_buffer(gs, size, params);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_centroid(Pointer gs) {
		var _result = _meos_b.geom_centroid(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_convex_hull(Pointer gs) {
		var _result = _meos_b.geom_convex_hull(gs);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_difference2d(Pointer gs1, Pointer gs2) {
		var _result = _meos_b.geom_difference2d(gs1, gs2);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_intersection2d(Pointer gs1, Pointer gs2) {
		var _result = _meos_b.geom_intersection2d(gs1, gs2);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_intersection2d_coll(Pointer gs1, Pointer gs2) {
		var _result = _meos_b.geom_intersection2d_coll(gs1, gs2);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_min_bounding_radius(Pointer geom, Pointer radius) {
		var _result = _meos_b.geom_min_bounding_radius(geom, radius);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_shortestline2d(Pointer gs1, Pointer s2) {
		var _result = _meos_b.geom_shortestline2d(gs1, s2);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_shortestline3d(Pointer gs1, Pointer s2) {
		var _result = _meos_b.geom_shortestline3d(gs1, s2);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer geom_unary_union(Pointer gs, double prec) {
		var _result = _meos_b.geom_unary_union(gs, prec);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer line_interpolate_point(Pointer gs, double distance_fraction, int repeat) {
		var _result = _meos_b.line_interpolate_point(gs, distance_fraction, repeat);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static double line_locate_point(Pointer gs1, Pointer gs2) {
		var _result = _meos_b.line_locate_point(gs1, gs2);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer line_substring(Pointer gs, double from, double to) {
		var _result = _meos_b.line_substring(gs, from, to);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int geog_dwithin(Pointer g1, Pointer g2, double tolerance, int use_spheroid) {
		var _result = _meos_b.geog_dwithin(g1, g2, tolerance, use_spheroid);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int geog_intersects(Pointer gs1, Pointer gs2, int use_spheroid) {
		var _result = _meos_b.geog_intersects(gs1, gs2, use_spheroid);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int geom_contains(Pointer gs1, Pointer gs2) {
		var _result = _meos_b.geom_contains(gs1, gs2);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int geom_covers(Pointer gs1, Pointer gs2) {
		var _result = _meos_b.geom_covers(gs1, gs2);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int geom_disjoint2d(Pointer gs1, Pointer gs2) {
		var _result = _meos_b.geom_disjoint2d(gs1, gs2);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int geom_dwithin2d(Pointer gs1, Pointer gs2, double tolerance) {
	...
	@SuppressWarnings("unused")
	public static int geom_dwithin3d(Pointer gs1, Pointer gs2, double tolerance) {
	...
	@SuppressWarnings("unused")
	public static int geom_intersects2d(Pointer gs1, Pointer gs2) {
	...
	@SuppressWarnings("unused")
	public static int geom_intersects3d(Pointer gs1, Pointer gs2) {
	...
	@SuppressWarnings("unused")
	public static int geom_relate_pattern(Pointer gs1, Pointer gs2, String patt) {
	...
	@SuppressWarnings("unused")
	public static int geom_touches(Pointer gs1, Pointer gs2) {
	...
	@SuppressWarnings("unused")
	public static int geo_same(Pointer gs1, Pointer gs2) {
	...
	@SuppressWarnings("unused")
	public static int geoset_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_c.geoset_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int contained_geo_set(Pointer gs, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_geo(Pointer s, Pointer gs) {
	...
	@SuppressWarnings("unused")
	public static Pointer spatialset_transform_pipeline(Pointer s, String pipelinestr, int srid, int is_forward) {
	...
	@SuppressWarnings("unused")
	public static Pointer geo_timestamptz_to_stbox(Pointer gs, int t) {
		var _result = _meos_c.geo_timestamptz_to_stbox(gs, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer stbox_make(int hasx, int hasz, int geodetic, int srid, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static Pointer timestamptz_to_stbox(int t) {
		var _result = _meos_c.timestamptz_to_stbox(t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static double stbox_area(Pointer box, int spheroid) {
	...
	@SuppressWarnings("unused")
	public static int stbox_hast(Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int stbox_hasx(Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int stbox_hasz(Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int stbox_isgeodetic(Pointer box) {
	...
	@SuppressWarnings("unused")
	public static double stbox_perimeter(Pointer box, int spheroid) {
	...
	@SuppressWarnings("unused")
	public static int stbox_tmax(Pointer box, Pointer result) {
		var _result = _meos_c.stbox_tmax(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int stbox_tmax_inc(Pointer box, Pointer result) {
		var _result = _meos_c.stbox_tmax_inc(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int stbox_tmin(Pointer box, Pointer result) {
		var _result = _meos_c.stbox_tmin(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int stbox_tmin_inc(Pointer box, Pointer result) {
		var _result = _meos_c.stbox_tmin_inc(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int stbox_xmax(Pointer box, Pointer result) {
		var _result = _meos_c.stbox_xmax(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int stbox_xmin(Pointer box, Pointer result) {
		var _result = _meos_c.stbox_xmin(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int stbox_ymax(Pointer box, Pointer result) {
		var _result = _meos_c.stbox_ymax(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int stbox_ymin(Pointer box, Pointer result) {
		var _result = _meos_c.stbox_ymin(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int stbox_zmax(Pointer box, Pointer result) {
		var _result = _meos_c.stbox_zmax(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int stbox_zmin(Pointer box, Pointer result) {
		var _result = _meos_c.stbox_zmin(box, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer stbox_transform_pipeline(Pointer box, String pipelinestr, int srid, int is_forward) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int contained_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int contains_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int same_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int above_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int after_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int back_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int before_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int below_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int front_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int left_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overabove_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overafter_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overback_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overbelow_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overfront_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overleft_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int overright_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int right_stbox_stbox(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static Pointer union_stbox_stbox(Pointer box1, Pointer box2, int strict) {
	...
	@SuppressWarnings("unused")
	public static int stbox_eq(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int stbox_ge(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int stbox_gt(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int stbox_le(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int stbox_lt(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static int stbox_ne(Pointer box1, Pointer box2) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeoinst_make(Pointer gs, int t) {
		var _result = _meos_c.tgeoinst_make(gs, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tpointinst_make(Pointer gs, int t) {
		var _result = _meos_c.tpointinst_make(gs, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tpointseq_make_coords(Pointer xcoords, Pointer ycoords, Pointer zcoords, Pointer times, int count, int srid, int geodetic, int lower_inc, int upper_inc, int interp, int normalize) {
	...
	@SuppressWarnings("unused")
	public static int tpoint_as_mvtgeom(Pointer temp, Pointer bounds, int extent, int buffer, int clip_geom, Pointer gsarr, Pointer timesarr, Pointer count) {
	...
	@SuppressWarnings("unused")
	public static int tpoint_tfloat_to_geomeas(Pointer tpoint, Pointer measure, int segmentize, Pointer result) {
		var _result = _meos_c.tpoint_tfloat_to_geomeas(tpoint, measure, segmentize, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int bearing_point_point(Pointer gs1, Pointer gs2, Pointer result) {
		var _result = _meos_c.bearing_point_point(gs1, gs2, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer bearing_tpoint_point(Pointer temp, Pointer gs, int invert) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeo_traversed_area(Pointer temp, int unary_union) {
	...
	@SuppressWarnings("unused")
	public static int tgeo_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value) {
		var _result = _meos_c.tgeo_value_at_timestamptz(temp, t, strict, value);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tgeo_value_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_c.tgeo_value_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tpoint_direction(Pointer temp, Pointer result) {
		var _result = _meos_c.tpoint_direction(temp, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tpoint_is_simple(Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer tpoint_trajectory(Pointer temp, int unary_union) {
	...
	@SuppressWarnings("unused")
	public static Pointer tspatial_transform_pipeline(Pointer temp, String pipelinestr, int srid, int is_forward) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeo_at_stbox(Pointer temp, Pointer box, int border_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeo_minus_stbox(Pointer temp, Pointer box, int border_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeo_space_boxes(Pointer temp, double xsize, double ysize, double zsize, Pointer sorigin, int bitmatrix, int border_inc, Pointer count) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeo_space_time_boxes(Pointer temp, double xsize, double ysize, double zsize, Pointer duration, Pointer sorigin, int torigin, int bitmatrix, int border_inc, Pointer count) {
		var _result = _meos_c.tgeo_space_time_boxes(temp, xsize, ysize, zsize, duration, sorigin, torigin, bitmatrix, border_inc, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int adjacent_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int contained_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int contained_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int contained_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int contains_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int contains_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int contains_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overlaps_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int same_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int same_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int same_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int above_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int above_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int above_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int after_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int after_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int after_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int back_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int back_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int back_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int before_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int before_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int before_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int below_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int below_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int below_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int front_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int front_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int front_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int left_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int left_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int left_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overabove_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overabove_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overabove_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overafter_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overafter_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overafter_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overback_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overback_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overback_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overbefore_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overbelow_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overbelow_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overbelow_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overfront_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overfront_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overfront_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overleft_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overleft_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overleft_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int overright_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int overright_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int overright_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static int right_stbox_tspatial(Pointer box, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int right_tspatial_stbox(Pointer temp, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int right_tspatial_tspatial(Pointer temp1, Pointer temp2) {
	...
	@SuppressWarnings("unused")
	public static Pointer stbox_get_space_time_tile(Pointer point, int t, double xsize, double ysize, double zsize, Pointer duration, Pointer sorigin, int torigin) {
		var _result = _meos_c.stbox_get_space_time_tile(point, t, xsize, ysize, zsize, duration, sorigin, torigin);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer stbox_get_time_tile(int t, Pointer duration, int torigin) {
		var _result = _meos_c.stbox_get_time_tile(t, duration, torigin);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer stbox_space_tiles(Pointer bounds, double xsize, double ysize, double zsize, Pointer sorigin, int border_inc, Pointer count) {
	...
	@SuppressWarnings("unused")
	public static Pointer stbox_space_time_tiles(Pointer bounds, double xsize, double ysize, double zsize, Pointer duration, Pointer sorigin, int torigin, int border_inc, Pointer count) {
		var _result = _meos_c.stbox_space_time_tiles(bounds, xsize, ysize, zsize, duration, sorigin, torigin, border_inc, count);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer stbox_time_tiles(Pointer bounds, Pointer duration, int torigin, int border_inc, Pointer count) {
		var _result = _meos_c.stbox_time_tiles(bounds, duration, torigin, border_inc, count);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tgeo_space_split(Pointer temp, double xsize, double ysize, double zsize, Pointer sorigin, int bitmatrix, int border_inc, Pointer space_bins, Pointer count) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeo_space_time_split(Pointer temp, double xsize, double ysize, double zsize, Pointer duration, Pointer sorigin, int torigin, int bitmatrix, int border_inc, Pointer space_bins, Pointer time_bins, Pointer count) {
		var _result = _meos_c.tgeo_space_time_split(temp, xsize, ysize, zsize, duration, sorigin, torigin, bitmatrix, border_inc, space_bins, time_bins, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer cbuffer_transform_pipeline(Pointer cb, String pipelinestr, int srid, int is_forward) {
	...
	@SuppressWarnings("unused")
	public static Pointer cbuffer_timestamptz_to_stbox(Pointer cb, int t) {
		var _result = _meos_c.cbuffer_timestamptz_to_stbox(cb, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int cbuffer_eq(Pointer cb1, Pointer cb2) {
	...
	@SuppressWarnings("unused")
	public static int cbuffer_ge(Pointer cb1, Pointer cb2) {
	...
	@SuppressWarnings("unused")
	public static int cbuffer_gt(Pointer cb1, Pointer cb2) {
	...
	@SuppressWarnings("unused")
	public static int cbuffer_le(Pointer cb1, Pointer cb2) {
	...
	@SuppressWarnings("unused")
	public static int cbuffer_lt(Pointer cb1, Pointer cb2) {
	...
	@SuppressWarnings("unused")
	public static int cbuffer_ne(Pointer cb1, Pointer cb2) {
	...
	@SuppressWarnings("unused")
	public static int cbuffer_nsame(Pointer cb1, Pointer cb2) {
	...
	@SuppressWarnings("unused")
	public static int cbuffer_same(Pointer cb1, Pointer cb2) {
	...
	@SuppressWarnings("unused")
	public static int cbufferset_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_c.cbufferset_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int contained_cbuffer_set(Pointer cb, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_cbuffer(Pointer s, Pointer cb) {
	...
	@SuppressWarnings("unused")
	public static Pointer tcbufferinst_make(Pointer cb, int t) {
		var _result = _meos_c.tcbufferinst_make(cb, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tcbuffer_from_base_temp(Pointer cb, Pointer temp) {
		var _result = _meos_c.tcbuffer_from_base_temp(cb, temp);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tcbufferseq_from_base_tstzset(Pointer cb, Pointer s) {
		var _result = _meos_c.tcbufferseq_from_base_tstzset(cb, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tcbufferseq_from_base_tstzspan(Pointer cb, Pointer s, int interp) {
		var _result = _meos_c.tcbufferseq_from_base_tstzspan(cb, s, interp);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tcbufferseqset_from_base_tstzspanset(Pointer cb, Pointer ss, int interp) {
		var _result = _meos_c.tcbufferseqset_from_base_tstzspanset(cb, ss, interp);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tcbuffer_end_value(Pointer temp) {
		var _result = _meos_c.tcbuffer_end_value(temp);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tcbuffer_start_value(Pointer temp) {
		var _result = _meos_c.tcbuffer_start_value(temp);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tcbuffer_trav_area(Pointer temp, int merge_union) {
	...
	@SuppressWarnings("unused")
	public static int tcbuffer_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value) {
		var _result = _meos_c.tcbuffer_value_at_timestamptz(temp, t, strict, value);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tcbuffer_value_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_c.tcbuffer_value_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tcbuffer_values(Pointer temp, Pointer count) {
		var _result = _meos_c.tcbuffer_values(temp, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tcbuffer_at_stbox(Pointer temp, Pointer box, int border_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tcbuffer_minus_stbox(Pointer temp, Pointer box, int border_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer set_make(Pointer values, int count, int basetype, int order) {
	...
	@SuppressWarnings("unused")
	public static Pointer set_make_exp(Pointer values, int count, int maxcount, int basetype, int order) {
	...
	@SuppressWarnings("unused")
	public static Pointer set_make_free(Pointer values, int count, int basetype, int order) {
	...
	@SuppressWarnings("unused")
	public static Pointer span_make(Pointer lower, Pointer upper, int lower_inc, int upper_inc, int basetype) {
	...
	@SuppressWarnings("unused")
	public static void span_set(Pointer lower, Pointer upper, int lower_inc, int upper_inc, int basetype, int spantype, Pointer s) {
		_meos_c.span_set(lower, upper, lower_inc, upper_inc, basetype, spantype, s);
		MeosErrorHandler.checkError();
	}

	@SuppressWarnings("unused")
	public static Pointer spanset_make_exp(Pointer spans, int count, int maxcount, int normalize, int order) {
	...
	@SuppressWarnings("unused")
	public static Pointer spanset_make_free(Pointer spans, int count, int normalize, int order) {
	...
	@SuppressWarnings("unused")
	public static int numspanset_width(Pointer ss, int boundspan) {
	...
	@SuppressWarnings("unused")
	public static int set_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_c.set_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer numset_shift_scale(Pointer s, Pointer shift, Pointer width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer numspan_shift_scale(Pointer s, Pointer shift, Pointer width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer numspanset_shift_scale(Pointer ss, Pointer shift, Pointer width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer textcat_textset_text_common(Pointer s, Pointer txt, int invert) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_span_value(Pointer s, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_spanset_value(Pointer ss, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int adjacent_value_spanset(Pointer value, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int contained_value_set(Pointer value, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_value_span(Pointer value, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contained_value_spanset(Pointer value, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_value(Pointer s, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int contains_span_value(Pointer s, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int contains_spanset_value(Pointer ss, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int ovadj_span_span(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int left_set_value(Pointer s, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int left_span_value(Pointer s, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int left_spanset_value(Pointer ss, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int left_value_set(Pointer value, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int left_value_span(Pointer value, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int left_value_spanset(Pointer value, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int lfnadj_span_span(Pointer s1, Pointer s2) {
	...
	@SuppressWarnings("unused")
	public static int overleft_set_value(Pointer s, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int overleft_span_value(Pointer s, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int overleft_spanset_value(Pointer ss, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int overleft_value_set(Pointer value, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overleft_value_span(Pointer value, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overleft_value_spanset(Pointer value, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int overright_set_value(Pointer s, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int overright_span_value(Pointer s, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int overright_spanset_value(Pointer ss, Pointer value) {
	...
	@SuppressWarnings("unused")
	public static int overright_value_set(Pointer value, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_value_span(Pointer value, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int overright_value_spanset(Pointer value, Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int right_value_set(Pointer value, Pointer s) {
		var _result = _meos_c.right_value_set(value, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int right_set_value(Pointer s, Pointer value) {
		var _result = _meos_c.right_set_value(s, value);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int right_value_span(Pointer value, Pointer s) {
		var _result = _meos_c.right_value_span(value, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int right_value_spanset(Pointer value, Pointer ss) {
		var _result = _meos_c.right_value_spanset(value, ss);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int right_span_value(Pointer s, Pointer value) {
		var _result = _meos_c.right_span_value(s, value);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int right_spanset_value(Pointer ss, Pointer value) {
		var _result = _meos_c.right_spanset_value(ss, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int bbox_type(int bboxtype) {
		var _result = _meos_c.bbox_type(bboxtype);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int bbox_get_size(int bboxtype) {
		var _result = _meos_c.bbox_get_size(bboxtype);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int bbox_max_dims(int bboxtype) {
		var _result = _meos_c.bbox_max_dims(bboxtype);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int temporal_bbox_eq(Pointer box1, Pointer box2, int temptype) {
		var _result = _meos_c.temporal_bbox_eq(box1, box2, temptype);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int temporal_bbox_cmp(Pointer box1, Pointer box2, int temptype) {
		var _result = _meos_c.temporal_bbox_cmp(box1, box2, temptype);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static void bbox_union_span_span(Pointer s1, Pointer s2, Pointer result) {
		_meos_c.bbox_union_span_span(s1, s2, result);
		MeosErrorHandler.checkError();
	}

	@SuppressWarnings("unused")
	public static int inter_span_span(Pointer s1, Pointer s2, Pointer result) {
		var _result = _meos_c.inter_span_span(s1, s2, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer intersection_set_value(Pointer s, Pointer value) {
		var _result = _meos_c.intersection_set_value(s, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer intersection_span_value(Pointer s, Pointer value) {
		var _result = _meos_c.intersection_span_value(s, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer intersection_spanset_value(Pointer ss, Pointer value) {
		var _result = _meos_c.intersection_spanset_value(ss, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer intersection_value_set(Pointer value, Pointer s) {
		var _result = _meos_c.intersection_value_set(value, s);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer intersection_value_span(Pointer value, Pointer s) {
		var _result = _meos_c.intersection_value_span(value, s);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer intersection_value_spanset(Pointer value, Pointer ss) {
		var _result = _meos_c.intersection_value_spanset(value, ss);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int mi_span_span(Pointer s1, Pointer s2, Pointer result) {
		var _result = _meos_c.mi_span_span(s1, s2, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer minus_set_value(Pointer s, Pointer value) {
		var _result = _meos_c.minus_set_value(s, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer minus_span_value(Pointer s, Pointer value) {
		var _result = _meos_c.minus_span_value(s, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer minus_spanset_value(Pointer ss, Pointer value) {
		var _result = _meos_c.minus_spanset_value(ss, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer minus_value_set(Pointer value, Pointer s) {
		var _result = _meos_c.minus_value_set(value, s);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer minus_value_span(Pointer value, Pointer s) {
		var _result = _meos_c.minus_value_span(value, s);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer minus_value_spanset(Pointer value, Pointer ss) {
		var _result = _meos_c.minus_value_spanset(value, ss);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer super_union_span_span(Pointer s1, Pointer s2) {
		var _result = _meos_c.super_union_span_span(s1, s2);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer union_set_value(Pointer s, Pointer value) {
		var _result = _meos_c.union_set_value(s, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer union_span_value(Pointer s, Pointer value) {
		var _result = _meos_c.union_span_value(s, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer union_spanset_value(Pointer ss, Pointer value) {
		var _result = _meos_c.union_spanset_value(ss, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer union_value_set(Pointer value, Pointer s) {
		var _result = _meos_c.union_value_set(value, s);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer union_value_span(Pointer value, Pointer s) {
		var _result = _meos_c.union_value_span(value, s);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static Pointer union_value_spanset(Pointer value, Pointer ss) {
		var _result = _meos_c.union_value_spanset(value, ss);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int distance_set_set(Pointer s1, Pointer s2) {
		var _result = _meos_c.distance_set_set(s1, s2);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static int distance_set_value(Pointer s, Pointer value) {
		var _result = _meos_c.distance_set_value(s, value);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer number_timestamptz_to_tbox(Pointer d, int basetype, int t) {
		var _result = _meos_c.number_timestamptz_to_tbox(d, basetype, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	public static void numset_set_tbox(Pointer s, Pointer box) {
		_meos_c.numset_set_tbox(s, box);
		MeosErrorHandler.checkError();
	}

	@SuppressWarnings("unused")
	public static void numspan_set_tbox(Pointer span, Pointer box) {
		_meos_c.numspan_set_tbox(span, box);
		MeosErrorHandler.checkError();
	}

	@SuppressWarnings("unused")
	public static void timestamptz_set_tbox(int t, Pointer box) {
		_meos_c.timestamptz_set_tbox(t, box);
		MeosErrorHandler.checkError();
	}

	@SuppressWarnings("unused")
	public static void tstzset_set_tbox(Pointer s, Pointer box) {
		_meos_c.tstzset_set_tbox(s, box);
		MeosErrorHandler.checkError();
	}

	@SuppressWarnings("unused")
	public static void tstzspan_set_tbox(Pointer s, Pointer box) {
		_meos_c.tstzspan_set_tbox(s, box);
		MeosErrorHandler.checkError();
	}

	@SuppressWarnings("unused")
	public static Pointer tbox_shift_scale_value(Pointer box, Pointer shift, Pointer width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static int inter_tbox_tbox(Pointer box1, Pointer box2, Pointer result) {
		var _result = _meos_d.inter_tbox_tbox(box1, box2, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tinstant_from_mfjson(Pointer mfjson, int spatial, int srid, int temptype) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_from_mfjson(Pointer mfjson, int spatial, int srid, int temptype, int interp) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_from_mfjson(Pointer mfjson, int spatial, int srid, int temptype, int interp) {
	...
	@SuppressWarnings("unused")
	public static Pointer tinstant_make(Pointer value, int temptype, int t) {
		var _result = _meos_d.tinstant_make(value, temptype, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tinstant_make_free(Pointer value, int temptype, int t) {
		var _result = _meos_d.tinstant_make_free(value, temptype, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_make_exp(Pointer instants, int count, int maxcount, int lower_inc, int upper_inc, int interp, int normalize) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_make_free(Pointer instants, int count, int lower_inc, int upper_inc, int interp, int normalize) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_make_exp(Pointer sequences, int count, int maxcount, int normalize) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_make_free(Pointer sequences, int count, int normalize) {
	...
	@SuppressWarnings("unused")
	public static int temporal_value_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_d.temporal_value_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tinstant_value_at_timestamptz(Pointer inst, int t, Pointer result) {
		var _result = _meos_d.tinstant_value_at_timestamptz(inst, t, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tsequence_end_timestamptz(Pointer seq) {
	...
	@SuppressWarnings("unused")
	public static int tsequence_start_timestamptz(Pointer seq) {
	...
	@SuppressWarnings("unused")
	public static int tsequence_value_at_timestamptz(Pointer seq, int t, int strict, Pointer result) {
		var _result = _meos_d.tsequence_value_at_timestamptz(seq, t, strict, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_duration(Pointer ss, int boundspan) {
	...
	@SuppressWarnings("unused")
	public static int tsequenceset_end_timestamptz(Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int tsequenceset_start_timestamptz(Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static int tsequenceset_timestamptz_n(Pointer ss, int n, Pointer result) {
		var _result = _meos_d.tsequenceset_timestamptz_n(ss, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tsequenceset_value_at_timestamptz(Pointer ss, int t, int strict, Pointer result) {
		var _result = _meos_d.tsequenceset_value_at_timestamptz(ss, t, strict, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tsequenceset_value_n(Pointer ss, int n, Pointer result) {
		var _result = _meos_d.tsequenceset_value_n(ss, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tnumber_shift_scale_value(Pointer temp, Pointer shift, Pointer width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnumberseq_shift_scale_value(Pointer seq, Pointer shift, Pointer width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnumberseqset_shift_scale_value(Pointer ss, Pointer start, Pointer width, int hasshift, int haswidth) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_subseq(Pointer seq, int from, int to, int lower_inc, int upper_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_append_tinstant(Pointer seq, Pointer inst, double maxdist, Pointer maxt, int expand) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_append_tsequence(Pointer seq1, Pointer seq2, int expand) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_delete_timestamptz(Pointer seq, int t, int connect) {
		var _result = _meos_d.tsequence_delete_timestamptz(seq, t, connect);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tsequence_delete_tstzset(Pointer seq, Pointer s, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_delete_tstzspan(Pointer seq, Pointer s, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_delete_tstzspanset(Pointer seq, Pointer ss, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_insert(Pointer seq1, Pointer seq2, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_append_tinstant(Pointer ss, Pointer inst, double maxdist, Pointer maxt, int expand) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_append_tsequence(Pointer ss, Pointer seq, int expand) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_delete_timestamptz(Pointer ss, int t) {
		var _result = _meos_d.tsequenceset_delete_timestamptz(ss, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tcontseq_after_timestamptz(Pointer seq, int t, int strict) {
		var _result = _meos_d.tcontseq_after_timestamptz(seq, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tcontseq_before_timestamptz(Pointer seq, int t, int strict) {
		var _result = _meos_d.tcontseq_before_timestamptz(seq, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tcontseq_restrict_minmax(Pointer seq, int min, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tdiscseq_after_timestamptz(Pointer seq, int t, int strict) {
		var _result = _meos_d.tdiscseq_after_timestamptz(seq, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tdiscseq_before_timestamptz(Pointer seq, int t, int strict) {
		var _result = _meos_d.tdiscseq_before_timestamptz(seq, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tdiscseq_restrict_minmax(Pointer seq, int min, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static int temporal_bbox_restrict_set(Pointer temp, Pointer set) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_restrict_minmax(Pointer temp, int min, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_restrict_timestamptz(Pointer temp, int t, int atfunc) {
		var _result = _meos_d.temporal_restrict_timestamptz(temp, t, atfunc);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer temporal_restrict_tstzset(Pointer temp, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_restrict_tstzspan(Pointer temp, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_restrict_tstzspanset(Pointer temp, Pointer ss, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_restrict_value(Pointer temp, Pointer value, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer temporal_restrict_values(Pointer temp, Pointer set, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static int temporal_value_at_timestamptz(Pointer temp, int t, int strict, Pointer result) {
		var _result = _meos_d.temporal_value_at_timestamptz(temp, t, strict, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tinstant_after_timestamptz(Pointer inst, int t, int strict) {
		var _result = _meos_d.tinstant_after_timestamptz(inst, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tinstant_before_timestamptz(Pointer inst, int t, int strict) {
		var _result = _meos_d.tinstant_before_timestamptz(inst, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tinstant_restrict_tstzspan(Pointer inst, Pointer period, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tinstant_restrict_tstzspanset(Pointer inst, Pointer ss, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tinstant_restrict_timestamptz(Pointer inst, int t, int atfunc) {
		var _result = _meos_d.tinstant_restrict_timestamptz(inst, t, atfunc);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tinstant_restrict_tstzset(Pointer inst, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tinstant_restrict_value(Pointer inst, Pointer value, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tinstant_restrict_values(Pointer inst, Pointer set, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnumber_restrict_span(Pointer temp, Pointer span, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnumber_restrict_spanset(Pointer temp, Pointer ss, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnumberinst_restrict_span(Pointer inst, Pointer span, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnumberinst_restrict_spanset(Pointer inst, Pointer ss, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnumberseqset_restrict_span(Pointer ss, Pointer span, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnumberseqset_restrict_spanset(Pointer ss, Pointer spanset, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_at_timestamptz(Pointer seq, int t) {
		var _result = _meos_d.tsequence_at_timestamptz(seq, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tsequence_restrict_tstzspan(Pointer seq, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequence_restrict_tstzspanset(Pointer seq, Pointer ss, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_after_timestamptz(Pointer ss, int t, int strict) {
		var _result = _meos_d.tsequenceset_after_timestamptz(ss, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tsequenceset_before_timestamptz(Pointer ss, int t, int strict) {
		var _result = _meos_d.tsequenceset_before_timestamptz(ss, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tsequenceset_restrict_minmax(Pointer ss, int min, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_restrict_tstzspan(Pointer ss, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_restrict_tstzspanset(Pointer ss, Pointer ps, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_restrict_timestamptz(Pointer ss, int t, int atfunc) {
		var _result = _meos_d.tsequenceset_restrict_timestamptz(ss, t, atfunc);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tsequenceset_restrict_tstzset(Pointer ss, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_restrict_value(Pointer ss, Pointer value, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tsequenceset_restrict_values(Pointer ss, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static int tinstant_eq(Pointer inst1, Pointer inst2) {
	...
	@SuppressWarnings("unused")
	public static int tsequence_eq(Pointer seq1, Pointer seq2) {
	...
	@SuppressWarnings("unused")
	public static int tsequenceset_eq(Pointer ss1, Pointer ss2) {
	...
	@SuppressWarnings("unused")
	public static void skiplist_splice(Pointer list, Pointer keys, Pointer values, int count, Pointer func, int crossings, int sktype) {
		_meos_d.skiplist_splice(list, keys, values, count, func, crossings, sktype);
		MeosErrorHandler.checkError();
	}

	@SuppressWarnings("unused")
	public static void temporal_skiplist_splice(Pointer list, Pointer values, int count, Pointer func, int crossings) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnumber_value_time_boxes(Pointer temp, Pointer vsize, Pointer duration, Pointer vorigin, int torigin, Pointer count) {
		var _result = _meos_d.tnumber_value_time_boxes(temp, vsize, duration, vorigin, torigin, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tbox_get_value_time_tile(Pointer value, int t, Pointer vsize, Pointer duration, Pointer vorigin, int torigin, int basetype, int spantype) {
		var _result = _meos_d.tbox_get_value_time_tile(value, t, vsize, duration, vorigin, torigin, basetype, spantype);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tnumber_value_time_split(Pointer temp, Pointer size, Pointer duration, Pointer vorigin, int torigin, Pointer value_bins, Pointer time_bins, Pointer count) {
		var _result = _meos_d.tnumber_value_time_split(temp, size, duration, vorigin, torigin, value_bins, time_bins, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static void stbox_set(int hasx, int hasz, int geodetic, int srid, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax, Pointer s, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int geo_set_stbox(Pointer gs, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int spatial_set_stbox(Pointer d, int basetype, Pointer box) {
	...
	@SuppressWarnings("unused")
	public static int inter_stbox_stbox(Pointer box1, Pointer box2, Pointer result) {
		var _result = _meos_d.inter_stbox_stbox(box1, box2, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tgeo_restrict_elevation(Pointer temp, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeo_restrict_geom(Pointer temp, Pointer gs, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeo_restrict_stbox(Pointer temp, Pointer box, int border_inc, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeoinst_restrict_geom(Pointer inst, Pointer gs, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeoinst_restrict_stbox(Pointer inst, Pointer box, int border_inc, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeoseq_restrict_geom(Pointer seq, Pointer gs, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeoseq_restrict_stbox(Pointer seq, Pointer box, int border_inc, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeoseqset_restrict_geom(Pointer ss, Pointer gs, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeoseqset_restrict_stbox(Pointer ss, Pointer box, int border_inc, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static int spatial_set_srid(Pointer d, int basetype, int srid) {
	...
	@SuppressWarnings("unused")
	public static int tpointseq_is_simple(Pointer seq) {
	...
	@SuppressWarnings("unused")
	public static Pointer tpointseq_linear_trajectory(Pointer seq, int unary_union) {
	...
	@SuppressWarnings("unused")
	public static int tpointseqset_is_simple(Pointer ss) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeominst_tgeoginst(Pointer inst, int oper) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeomseq_tgeogseq(Pointer seq, int oper) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeomseqset_tgeogseqset(Pointer ss, int oper) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeom_tgeog(Pointer temp, int oper) {
	...
	@SuppressWarnings("unused")
	public static Pointer tgeo_tpoint(Pointer temp, int oper) {
	...
	@SuppressWarnings("unused")
	public static Pointer npoint_make(int rid, double pos) {
	...
	@SuppressWarnings("unused")
	public static Pointer nsegment_make(int rid, double pos1, double pos2) {
	...
	@SuppressWarnings("unused")
	public static int npoint_route(Pointer np) {
	...
	@SuppressWarnings("unused")
	public static int nsegment_route(Pointer ns) {
	...
	@SuppressWarnings("unused")
	public static int route_exists(int rid) {
	...
	@SuppressWarnings("unused")
	public static Pointer route_geom(int rid) {
	...
	@SuppressWarnings("unused")
	public static Pointer npoint_timestamptz_to_stbox(Pointer np, int t) {
		var _result = _meos_d.npoint_timestamptz_to_stbox(np, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int npoint_eq(Pointer np1, Pointer np2) {
	...
	@SuppressWarnings("unused")
	public static int npoint_ge(Pointer np1, Pointer np2) {
	...
	@SuppressWarnings("unused")
	public static int npoint_gt(Pointer np1, Pointer np2) {
	...
	@SuppressWarnings("unused")
	public static int npoint_le(Pointer np1, Pointer np2) {
	...
	@SuppressWarnings("unused")
	public static int npoint_lt(Pointer np1, Pointer np2) {
	...
	@SuppressWarnings("unused")
	public static int npoint_ne(Pointer np1, Pointer np2) {
	...
	@SuppressWarnings("unused")
	public static int npoint_same(Pointer np1, Pointer np2) {
	...
	@SuppressWarnings("unused")
	public static int nsegment_eq(Pointer ns1, Pointer ns2) {
	...
	@SuppressWarnings("unused")
	public static int nsegment_ge(Pointer ns1, Pointer ns2) {
	...
	@SuppressWarnings("unused")
	public static int nsegment_gt(Pointer ns1, Pointer ns2) {
	...
	@SuppressWarnings("unused")
	public static int nsegment_le(Pointer ns1, Pointer ns2) {
	...
	@SuppressWarnings("unused")
	public static int nsegment_lt(Pointer ns1, Pointer ns2) {
	...
	@SuppressWarnings("unused")
	public static int nsegment_ne(Pointer ns1, Pointer ns2) {
	...
	@SuppressWarnings("unused")
	public static int npointset_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_d.npointset_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int contained_npoint_set(Pointer np, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_npoint(Pointer s, Pointer np) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnpointinst_make(Pointer np, int t) {
		var _result = _meos_d.tnpointinst_make(np, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tnpoint_from_base_temp(Pointer np, Pointer temp) {
		var _result = _meos_d.tnpoint_from_base_temp(np, temp);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tnpointseq_from_base_tstzset(Pointer np, Pointer s) {
		var _result = _meos_d.tnpointseq_from_base_tstzset(np, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tnpointseq_from_base_tstzspan(Pointer np, Pointer s, int interp) {
		var _result = _meos_d.tnpointseq_from_base_tstzspan(np, s, interp);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tnpointseqset_from_base_tstzspanset(Pointer np, Pointer ss, int interp) {
		var _result = _meos_d.tnpointseqset_from_base_tstzspanset(np, ss, interp);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tnpoint_end_value(Pointer temp) {
		var _result = _meos_d.tnpoint_end_value(temp);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tnpoint_route(Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnpoint_start_value(Pointer temp) {
		var _result = _meos_d.tnpoint_start_value(temp);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tnpoint_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value) {
		var _result = _meos_d.tnpoint_value_at_timestamptz(temp, t, strict, value);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tnpoint_value_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_d.tnpoint_value_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tnpoint_values(Pointer temp, Pointer count) {
		var _result = _meos_d.tnpoint_values(temp, count);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tnpoint_at_stbox(Pointer temp, Pointer box, int border_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tnpoint_minus_stbox(Pointer temp, Pointer box, int border_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer pose_transform_pipeline(Pointer pose, String pipelinestr, int srid, int is_forward) {
	...
	@SuppressWarnings("unused")
	public static Pointer pose_timestamptz_to_stbox(Pointer pose, int t) {
		var _result = _meos_d.pose_timestamptz_to_stbox(pose, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int pose_eq(Pointer pose1, Pointer pose2) {
	...
	@SuppressWarnings("unused")
	public static int pose_ge(Pointer pose1, Pointer pose2) {
	...
	@SuppressWarnings("unused")
	public static int pose_gt(Pointer pose1, Pointer pose2) {
	...
	@SuppressWarnings("unused")
	public static int pose_le(Pointer pose1, Pointer pose2) {
	...
	@SuppressWarnings("unused")
	public static int pose_lt(Pointer pose1, Pointer pose2) {
	...
	@SuppressWarnings("unused")
	public static int pose_ne(Pointer pose1, Pointer pose2) {
	...
	@SuppressWarnings("unused")
	public static int pose_nsame(Pointer pose1, Pointer pose2) {
	...
	@SuppressWarnings("unused")
	public static int pose_same(Pointer pose1, Pointer pose2) {
	...
	@SuppressWarnings("unused")
	public static int poseset_value_n(Pointer s, int n, Pointer result) {
		var _result = _meos_d.poseset_value_n(s, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int contained_pose_set(Pointer pose, Pointer s) {
	...
	@SuppressWarnings("unused")
	public static int contains_set_pose(Pointer s, Pointer pose) {
	...
	@SuppressWarnings("unused")
	public static Pointer tpose_from_mfjson(String str) {
		var _result = _meos_d.tpose_from_mfjson(str);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tposeinst_make(Pointer pose, int t) {
		var _result = _meos_d.tposeinst_make(pose, t);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tpose_from_base_temp(Pointer pose, Pointer temp) {
		var _result = _meos_d.tpose_from_base_temp(pose, temp);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tposeseq_from_base_tstzset(Pointer pose, Pointer s) {
		var _result = _meos_d.tposeseq_from_base_tstzset(pose, s);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tposeseq_from_base_tstzspan(Pointer pose, Pointer s, int interp) {
		var _result = _meos_d.tposeseq_from_base_tstzspan(pose, s, interp);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer tposeseqset_from_base_tstzspanset(Pointer pose, Pointer ss, int interp) {
		var _result = _meos_d.tposeseqset_from_base_tstzspanset(pose, ss, interp);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int tpose_value_at_timestamptz(Pointer temp, int t, int strict, Pointer value) {
		var _result = _meos_d.tpose_value_at_timestamptz(temp, t, strict, value);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static int tpose_value_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_d.tpose_value_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static Pointer tpose_at_stbox(Pointer temp, Pointer box, int border_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer tpose_minus_stbox(Pointer temp, Pointer box, int border_inc) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeoinst_make(Pointer geom, Pointer pose, int t) {
		var _result = _meos_d.trgeoinst_make(geom, pose, t);
		MeosErrorHandler.checkError();
		return _result;
	}
	...
	@SuppressWarnings("unused")
	public static int trgeo_value_n(Pointer temp, int n, Pointer result) {
		var _result = _meos_d.trgeo_value_n(temp, n, result);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer trgeo_traversed_area(Pointer temp, int unary_union) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeo_append_tinstant(Pointer temp, Pointer inst, int interp, double maxdist, Pointer maxt, int expand) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeo_append_tsequence(Pointer temp, Pointer seq, int expand) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeo_delete_timestamptz(Pointer temp, int t, int connect) {
		var _result = _meos_d.trgeo_delete_timestamptz(temp, t, connect);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer trgeo_delete_tstzset(Pointer temp, Pointer s, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeo_delete_tstzspan(Pointer temp, Pointer s, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeo_delete_tstzspanset(Pointer temp, Pointer ss, int connect) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeo_after_timestamptz(Pointer temp, int t, int strict) {
		var _result = _meos_d.trgeo_after_timestamptz(temp, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer trgeo_before_timestamptz(Pointer temp, int t, int strict) {
		var _result = _meos_d.trgeo_before_timestamptz(temp, t, strict);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer trgeo_restrict_value(Pointer temp, Pointer value, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeo_restrict_values(Pointer temp, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeo_restrict_timestamptz(Pointer temp, int t, int atfunc) {
		var _result = _meos_d.trgeo_restrict_timestamptz(temp, t, atfunc);
		MeosErrorHandler.checkError();
		return _result;
	}

	@SuppressWarnings("unused")
	public static Pointer trgeo_restrict_tstzset(Pointer temp, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeo_restrict_tstzspan(Pointer temp, Pointer s, int atfunc) {
	...
	@SuppressWarnings("unused")
	public static Pointer trgeo_restrict_tstzspanset(Pointer temp, Pointer ss, int atfunc) {
