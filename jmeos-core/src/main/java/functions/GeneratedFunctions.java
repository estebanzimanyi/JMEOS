...
public class GeneratedFunctions {
	...
	public interface MeosLibraryPartB {
		...
		boolean h3_are_neighbor_cells_meos(Pointer origin, Pointer destination);

		Pointer h3_cells_to_directed_edge_meos(Pointer origin, Pointer destination);

		boolean h3_is_valid_directed_edge_meos(Pointer edge);

		Pointer h3_get_directed_edge_origin_meos(Pointer edge);

		Pointer h3_get_directed_edge_destination_meos(Pointer edge);

		Pointer h3_cell_to_parent_meos(Pointer origin, int resolution);

		Pointer h3_cell_to_center_child_meos(Pointer origin, int resolution);

		long h3_cell_to_child_pos_meos(Pointer child, int parentRes);

		Pointer h3_child_pos_to_cell_meos(long childPos, Pointer parent, int childRes);

		int h3_get_resolution_meos(Pointer hex);

		int h3_get_base_cell_number_meos(Pointer hex);

		boolean h3_is_valid_cell_meos(Pointer hex);

		boolean h3_is_res_class_iii_meos(Pointer hex);

		boolean h3_is_pentagon_meos(Pointer hex);

		long h3_get_num_cells_meos(int resolution);

		long h3_grid_distance_meos(Pointer originIndex, Pointer h3Index);

		Pointer h3_cell_to_vertex_meos(Pointer cell, int vertexNum);

		boolean h3_is_valid_vertex_meos(Pointer vertex);

		Pointer h3index_parse(String str);

		String h3index_to_string(Pointer cell);

		boolean h3index_eq(Pointer a, Pointer b);

		boolean h3index_ne(Pointer a, Pointer b);

		boolean h3index_lt(Pointer a, Pointer b);

		boolean h3index_le(Pointer a, Pointer b);

		boolean h3index_gt(Pointer a, Pointer b);

		boolean h3index_ge(Pointer a, Pointer b);

		int h3index_cmp(Pointer a, Pointer b);

		int h3index_hash(Pointer cell);

		Pointer h3_grid_disk(Pointer origin, int k);

		Pointer h3_grid_ring(Pointer origin, int k);

		Pointer h3_grid_path_cells(Pointer start, Pointer end);

		Pointer h3_cell_to_children(Pointer origin, int childRes);

		Pointer h3_compact_cells(Pointer cells);

		Pointer h3_uncompact_cells(Pointer cells, int res);

		Pointer h3_origin_to_directed_edges(Pointer origin);

		Pointer h3_cell_to_vertexes(Pointer cell);

		Pointer h3_get_icosahedron_faces(Pointer cell);

		boolean ensure_valid_th3index_th3index(Pointer temp1, Pointer temp2);

		boolean ensure_valid_th3index_h3index(Pointer temp, Pointer cell);
		...
		Pointer h3_gs_point_to_cell(Pointer point, int resolution);

		Pointer h3_cell_to_gs_point(Pointer cell);

		Pointer h3_cell_to_gs_boundary(Pointer cell);

		Pointer cell_boundary_to_gs(Pointer bnd);

		double h3_sample_step_deg(int resolution);

		Pointer h3_latlng_deg_to_cell(double lat_deg, double lng_deg, int resolution);

		Pointer h3_cell_to_parent_next_meos(Pointer cell);

		Pointer h3_cell_to_center_child_next_meos(Pointer cell);

		Pointer h3_directed_edge_to_gs_boundary(Pointer edge);

		Pointer h3_vertex_to_gs_point(Pointer vertex);

		Pointer h3_cell_to_local_ij_meos(Pointer origin, Pointer cell);

		Pointer h3_local_ij_to_cell_meos(Pointer origin, Pointer coord);

		int h3_unit_from_cstring(String unit);

		double h3_cell_area_meos(Pointer cell, int unit);

		double h3_edge_length_meos(Pointer edge, int unit);
	...
	public interface MeosLibraryPartC {
		...
		Pointer h3index_in(String str);

		String h3index_out(Pointer cell);
		...
		Pointer th3index_make(Pointer value, long t);

		Pointer th3indexinst_make(Pointer value, long t);
		...
		Pointer th3index_start_value(Pointer temp);

		Pointer th3index_end_value(Pointer temp);
		...
		int ever_eq_h3index_th3index(Pointer cell, Pointer temp);

		int ever_eq_th3index_h3index(Pointer temp, Pointer cell);

		int ever_ne_h3index_th3index(Pointer cell, Pointer temp);

		int ever_ne_th3index_h3index(Pointer temp, Pointer cell);

		int always_eq_h3index_th3index(Pointer cell, Pointer temp);

		int always_eq_th3index_h3index(Pointer temp, Pointer cell);

		int always_ne_h3index_th3index(Pointer cell, Pointer temp);

		int always_ne_th3index_h3index(Pointer temp, Pointer cell);
		...
		Pointer teq_h3index_th3index(Pointer cell, Pointer temp);

		Pointer teq_th3index_h3index(Pointer temp, Pointer cell);

		Pointer teq_th3index_th3index(Pointer temp1, Pointer temp2);

		Pointer tne_h3index_th3index(Pointer cell, Pointer temp);

		Pointer tne_th3index_h3index(Pointer temp, Pointer cell);
	...
	@SuppressWarnings("unused")
	public static boolean h3_are_neighbor_cells_meos(Pointer origin, Pointer destination) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cells_to_directed_edge_meos(Pointer origin, Pointer destination) {
	...
	@SuppressWarnings("unused")
	public static boolean h3_is_valid_directed_edge_meos(Pointer edge) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_get_directed_edge_origin_meos(Pointer edge) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_get_directed_edge_destination_meos(Pointer edge) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cell_to_parent_meos(Pointer origin, int resolution) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cell_to_center_child_meos(Pointer origin, int resolution) {
	...
	@SuppressWarnings("unused")
	public static long h3_cell_to_child_pos_meos(Pointer child, int parentRes) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_child_pos_to_cell_meos(long childPos, Pointer parent, int childRes) {
	...
	@SuppressWarnings("unused")
	public static int h3_get_resolution_meos(Pointer hex) {
	...
	@SuppressWarnings("unused")
	public static int h3_get_base_cell_number_meos(Pointer hex) {
	...
	@SuppressWarnings("unused")
	public static boolean h3_is_valid_cell_meos(Pointer hex) {
	...
	@SuppressWarnings("unused")
	public static boolean h3_is_res_class_iii_meos(Pointer hex) {
	...
	@SuppressWarnings("unused")
	public static boolean h3_is_pentagon_meos(Pointer hex) {
	...
	@SuppressWarnings("unused")
	public static long h3_grid_distance_meos(Pointer originIndex, Pointer h3Index) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cell_to_vertex_meos(Pointer cell, int vertexNum) {
	...
	@SuppressWarnings("unused")
	public static boolean h3_is_valid_vertex_meos(Pointer vertex) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3index_parse(String str) {
	...
	@SuppressWarnings("unused")
	public static String h3index_to_string(Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static boolean h3index_eq(Pointer a, Pointer b) {
	...
	@SuppressWarnings("unused")
	public static boolean h3index_ne(Pointer a, Pointer b) {
	...
	@SuppressWarnings("unused")
	public static boolean h3index_lt(Pointer a, Pointer b) {
	...
	@SuppressWarnings("unused")
	public static boolean h3index_le(Pointer a, Pointer b) {
	...
	@SuppressWarnings("unused")
	public static boolean h3index_gt(Pointer a, Pointer b) {
	...
	@SuppressWarnings("unused")
	public static boolean h3index_ge(Pointer a, Pointer b) {
	...
	@SuppressWarnings("unused")
	public static int h3index_cmp(Pointer a, Pointer b) {
	...
	@SuppressWarnings("unused")
	public static int h3index_hash(Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_grid_disk(Pointer origin, int k) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_grid_ring(Pointer origin, int k) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_grid_path_cells(Pointer start, Pointer end) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cell_to_children(Pointer origin, int childRes) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_origin_to_directed_edges(Pointer origin) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cell_to_vertexes(Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_get_icosahedron_faces(Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static boolean ensure_valid_th3index_h3index(Pointer temp, Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_gs_point_to_cell(Pointer point, int resolution) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cell_to_gs_point(Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cell_to_gs_boundary(Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_latlng_deg_to_cell(double lat_deg, double lng_deg, int resolution) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cell_to_parent_next_meos(Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cell_to_center_child_next_meos(Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_directed_edge_to_gs_boundary(Pointer edge) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_vertex_to_gs_point(Pointer vertex) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_cell_to_local_ij_meos(Pointer origin, Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3_local_ij_to_cell_meos(Pointer origin, Pointer coord) {
	...
	@SuppressWarnings("unused")
	public static double h3_cell_area_meos(Pointer cell, int unit) {
	...
	@SuppressWarnings("unused")
	public static double h3_edge_length_meos(Pointer edge, int unit) {
	...
	@SuppressWarnings("unused")
	public static Pointer h3index_in(String str) {
	...
	@SuppressWarnings("unused")
	public static String h3index_out(Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer th3index_make(Pointer value, OffsetDateTime t) {
		var t_new = t.toEpochSecond();
	...
	@SuppressWarnings("unused")
	public static Pointer th3indexinst_make(Pointer value, OffsetDateTime t) {
		var t_new = t.toEpochSecond();
	...
	@SuppressWarnings("unused")
	public static Pointer th3index_start_value(Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer th3index_end_value(Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int ever_eq_h3index_th3index(Pointer cell, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int ever_eq_th3index_h3index(Pointer temp, Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static int ever_ne_h3index_th3index(Pointer cell, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int ever_ne_th3index_h3index(Pointer temp, Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static int always_eq_h3index_th3index(Pointer cell, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int always_eq_th3index_h3index(Pointer temp, Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static int always_ne_h3index_th3index(Pointer cell, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static int always_ne_th3index_h3index(Pointer temp, Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer teq_h3index_th3index(Pointer cell, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer teq_th3index_h3index(Pointer temp, Pointer cell) {
	...
	@SuppressWarnings("unused")
	public static Pointer tne_h3index_th3index(Pointer cell, Pointer temp) {
	...
	@SuppressWarnings("unused")
	public static Pointer tne_th3index_h3index(Pointer temp, Pointer cell) {
	...
	public static int ever_eq_anyof_h3indexset_th3index(Pointer cells, Pointer th3idx) {
		var _result = _meos_c.ever_eq_anyof_h3indexset_th3index(cells, th3idx);
		MeosErrorHandler.checkError();
		return _result;
	}
